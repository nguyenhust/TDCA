...
{
    [Serializable]
    public partial class BienLaiTamThuInfo : BusinessBase<BienLaiTamThuInfo>
    {
        #region Validation
        ...
        /// </summary>
        public static readonly PropertyInfo<Int64> IDHocVienProperty = RegisterProperty<Int64>(p => p.IDHocVien, "IDNguoi Ky Quy");
        /// <summary>
        /// ID nguoi thu ky quy
        /// </summary>
        ...
        public static BienLaiTamThuInfo NewBienLaiTamThuInfo()
        {
            //if (!CanAddObject())
            //    throw new System.Security.SecurityException("Bạn không có quyền thêm mới ký quỹ");
            return DataPortal.CreateChild<BienLaiTamThuInfo>();
        }
        ...
        internal static void NewBienLaiTamThuInfo(EventHandler<DataPortalResult<BienLaiTamThuInfo>> callback)
        {
            //if (!CanAddObject())
            //    throw new System.Security.SecurityException("Bạn không có quyền thêm mới ký quỹ");
            DataPortal.BeginCreate<BienLaiTamThuInfo>(callback);
        }
        ...
        internal static BienLaiTamThuInfo GetBienLaiTamThuInfo(SafeDataReader dr)
        {
            BienLaiTamThuInfo obj = new BienLaiTamThuInfo();
        ...
        internal static BienLaiTamThuInfo GetBienLaiTamThuInfoKQBD(SafeDataReader dr)
        {
            BienLaiTamThuInfo obj = new BienLaiTamThuInfo();
            // show the framework that this is a child object
            obj.MarkAsChild();
        ...
        internal static BienLaiTamThuInfo GetBienLaiTamThuInfoHKQ(SafeDataReader dr)
        {
            BienLaiTamThuInfo obj = new BienLaiTamThuInfo();
            // show the framework that this is a child object
            obj.MarkAsChild();
