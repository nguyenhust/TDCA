...
{
    [Serializable]
    public partial class BienLaiLopHoc : BusinessBase<BienLaiLopHoc>
    {
        ...
        public static readonly PropertyInfo<Int32> IDLopHocProperty = RegisterProperty<Int32>(p => p.IDLopHoc, "IDLopHoc");
        /// <summary>
        ...
        public static readonly PropertyInfo<Int64> IDHocVienProperty = RegisterProperty<Int64>(p => p.IDHocVien, "IDLopHoc");
        /// <summary>
        /// Gets or sets the IDDieu Tri.
        /// </summary>
        /// <value>The IDDieu Tri.</value>
        ...
        public class Criteria
        {
            ...
            public Criteria(Int32 lngIDLopHoc)
            {
                _intIDLopHoc = lngIDLopHoc;
            }
        }
        ...
        public static BienLaiLopHoc NewBienLaiLopHoc()
        {
            //if (!CanAddObject())
            //    throw new System.Security.SecurityException("Bạn không có quyền thêm mới ký quỹ");
            return DataPortal.Create<BienLaiLopHoc>();
        }
        ...
        public static BienLaiLopHoc GetBienLaiLopHoc(Int64 iDBienLai)
        {
            //if (!CanGetObject())
            //    throw new System.Security.SecurityException("Bạn không có quyền xem biên lai ký quỹ");
            return DataPortal.Fetch<BienLaiLopHoc>(iDBienLai);
        }
        //public static BienLaiLopHoc GetBienLaiTamThu_KQ(Int64 idHocVien)
        //{
        //    //if (!CanGetObject())
        //    //    throw new System.Security.SecurityException("Bạn không có quyền xem biên lai ký quỹ");
        ...
        public static void DeleteIP_KyQuy(long lngIDBienLai, long lngIDNguoiHuy, string strNguoiHuy, string strLyDoHuy)
        {
            ...
            DataPortal.Delete<BienLaiLopHoc>(new Criteria(lngIDBienLai, lngIDNguoiHuy, strNguoiHuy, strLyDoHuy));
        }
        ...
        public static void NewBienLaiLopHoc(EventHandler<DataPortalResult<BienLaiLopHoc>> callback)
        {
            DataPortal.BeginCreate<BienLaiLopHoc>(callback);
        }
        ...
        /// <param name="iDBienLai">The IDBienLai parameter of the IP_KyQuy to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetBienLaiLopHoc(Int64 iDBienLai, EventHandler<DataPortalResult<BienLaiLopHoc>> callback)
        {
            DataPortal.BeginFetch<BienLaiLopHoc>(iDBienLai, callback);
        }
        ...
        /// <param name="iDBienLai">The IDBienLai of the IP_KyQuy to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteBienLaiLopHoc(Int64 iDBienLai, EventHandler<DataPortalResult<BienLaiLopHoc>> callback)
        {
            DataPortal.BeginDelete<BienLaiLopHoc>(iDBienLai, callback);
        }

        public override BienLaiLopHoc Save()
        {
            //if (this.IsDirty)
            //if (!CanEditObject())
        ...
        protected void DataPortal_Fetch(Int64 iDBienLai)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.BienLaiLopHoc_Gets", ctx.Connection))
                {
        ...
        protected override void DataPortal_Insert()
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.BienLaiLopHoc_ins", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@IDLopHoc", ReadProperty(IDLopHocProperty)).DbType = DbType.Int32;
