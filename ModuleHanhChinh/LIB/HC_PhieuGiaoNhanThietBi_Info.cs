...
//
// Filename:    HC_PhieuGiaoNhanThietBi_Info
// ObjectType:  HC_PhieuGiaoNhanThietBi_Info
...
namespace ModuleHanhChinh.LIB
{
    ...
    /// <summary>
    /// HC_PhieuGiaoNhanThietBi_Info (editable child object).<br/>
    /// This is a generated base class of <see cref="HC_PhieuGiaoNhanThietBi_Info"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is an item of <see cref="HC_PhieuGiaoNhanThietBi_Coll"/> collection.
    /// </remarks>
    [Serializable]
    public partial class HC_PhieuGiaoNhanThietBi_Info : BusinessBase<HC_PhieuGiaoNhanThietBi_Info>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="HC_PhieuGiaoNhanThietBi_Info"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="HC_PhieuGiaoNhanThietBi_Info"/> object.</returns>
        internal static HC_PhieuGiaoNhanThietBi_Info NewHC_PhieuGiaoNhanThietBi_Info()
        {
            return DataPortal.CreateChild<HC_PhieuGiaoNhanThietBi_Info>();
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="HC_PhieuGiaoNhanThietBi_Info"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        internal static void NewHC_PhieuGiaoNhanThietBi_Info(EventHandler<DataPortalResult<HC_PhieuGiaoNhanThietBi_Info>> callback)
        {
            DataPortal.BeginCreate<HC_PhieuGiaoNhanThietBi_Info>(callback);
        }

        /// <summary>
        /// Factory method. Loads a <see cref="HC_PhieuGiaoNhanThietBi_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        /// <returns>A reference to the fetched <see cref="HC_PhieuGiaoNhanThietBi_Info"/> object.</returns>
        internal static HC_PhieuGiaoNhanThietBi_Info GetHC_PhieuGiaoNhanThietBi_Info(SafeDataReader dr)
        {
            HC_PhieuGiaoNhanThietBi_Info obj = new HC_PhieuGiaoNhanThietBi_Info();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HC_PhieuGiaoNhanThietBi_Info"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private HC_PhieuGiaoNhanThietBi_Info()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="HC_PhieuGiaoNhanThietBi_Info"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="HC_PhieuGiaoNhanThietBi_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        ...
        /// <summary>
        /// Inserts a new <see cref="HC_PhieuGiaoNhanThietBi_Info"/> object in the database.
        /// </summary>
        private void Child_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_PhieuGiaoNhanThietBi_Info_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="HC_PhieuGiaoNhanThietBi_Info"/> object.
        /// </summary>
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_PhieuGiaoNhanThietBi_Info_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="HC_PhieuGiaoNhanThietBi_Info"/> object from database.
        /// </summary>
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_PhieuGiaoNhanThietBi_Info_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", ReadProperty(IDProperty)).DbType = DbType.Int32;
