...
//
// Filename:    HC_CongVanDi
// ObjectType:  HC_CongVanDi
...
namespace ModuleHanhChinh.LIB
{
    ...
    /// <summary>
    /// HC_CongVanDi (editable root object).<br/>
    /// This is a generated base class of <see cref="HC_CongVanDi"/> business object.
    /// </summary>
    [Serializable]
    public partial class HC_CongVanDi : BusinessBase<HC_CongVanDi>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="HC_CongVanDi"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="HC_CongVanDi"/> object.</returns>
        public static HC_CongVanDi NewHC_CongVanDi()
        {
            return DataPortal.Create<HC_CongVanDi>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="HC_CongVanDi"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the HC_CongVanDi to fetch.</param>
        /// <returns>A reference to the fetched <see cref="HC_CongVanDi"/> object.</returns>
        public static HC_CongVanDi GetHC_CongVanDi(int id)
        {
            return DataPortal.Fetch<HC_CongVanDi>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="HC_CongVanDi"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the HC_CongVanDi to delete.</param>
        public static void DeleteHC_CongVanDi(int id)
        {
            DataPortal.Delete<HC_CongVanDi>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="HC_CongVanDi"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewHC_CongVanDi(EventHandler<DataPortalResult<HC_CongVanDi>> callback)
        {
            DataPortal.BeginCreate<HC_CongVanDi>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="HC_CongVanDi"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the HC_CongVanDi to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetHC_CongVanDi(int id, EventHandler<DataPortalResult<HC_CongVanDi>> callback)
        {
            DataPortal.BeginFetch<HC_CongVanDi>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="HC_CongVanDi"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the HC_CongVanDi to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteHC_CongVanDi(int id, EventHandler<DataPortalResult<HC_CongVanDi>> callback)
        {
            DataPortal.BeginDelete<HC_CongVanDi>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HC_CongVanDi"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private HC_CongVanDi()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="HC_CongVanDi"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="HC_CongVanDi"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.HC_CongVanDi_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="HC_CongVanDi"/> object from the given SafeDataReader.
        /// </summary>
    ...
    LoadProperty(LastEdited_UserIDProperty, dr.GetInt64("LastEdited_UserID"));
        ...
        /// <summary>
        /// Inserts a new <see cref="HC_CongVanDi"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_CongVanDi_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="HC_CongVanDi"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_CongVanDi_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="HC_CongVanDi"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="HC_CongVanDi"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_CongVanDi_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
