...
//
// Filename:    HC_ThietBiTienLamSang
// ObjectType:  HC_ThietBiTienLamSang
...
namespace ModuleHanhChinh.LIB
{
    ...
    /// <summary>
    /// HC_ThietBiTienLamSang (editable root object).<br/>
    /// This is a generated base class of <see cref="HC_ThietBiTienLamSang"/> business object.
    /// </summary>
    [Serializable]
    public partial class HC_ThietBiTienLamSang : BusinessBase<HC_ThietBiTienLamSang>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="HC_ThietBiTienLamSang"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="HC_ThietBiTienLamSang"/> object.</returns>
        public static HC_ThietBiTienLamSang NewHC_ThietBiTienLamSang()
        {
            return DataPortal.Create<HC_ThietBiTienLamSang>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="HC_ThietBiTienLamSang"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the HC_ThietBiTienLamSang to fetch.</param>
        /// <returns>A reference to the fetched <see cref="HC_ThietBiTienLamSang"/> object.</returns>
        public static HC_ThietBiTienLamSang GetHC_ThietBiTienLamSang(int id)
        {
            return DataPortal.Fetch<HC_ThietBiTienLamSang>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="HC_ThietBiTienLamSang"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the HC_ThietBiTienLamSang to delete.</param>
        public static void DeleteHC_ThietBiTienLamSang(int id)
        {
            DataPortal.Delete<HC_ThietBiTienLamSang>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="HC_ThietBiTienLamSang"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewHC_ThietBiTienLamSang(EventHandler<DataPortalResult<HC_ThietBiTienLamSang>> callback)
        {
            DataPortal.BeginCreate<HC_ThietBiTienLamSang>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="HC_ThietBiTienLamSang"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the HC_ThietBiTienLamSang to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetHC_ThietBiTienLamSang(int id, EventHandler<DataPortalResult<HC_ThietBiTienLamSang>> callback)
        {
            DataPortal.BeginFetch<HC_ThietBiTienLamSang>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="HC_ThietBiTienLamSang"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the HC_ThietBiTienLamSang to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteHC_ThietBiTienLamSang(int id, EventHandler<DataPortalResult<HC_ThietBiTienLamSang>> callback)
        {
            DataPortal.BeginDelete<HC_ThietBiTienLamSang>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HC_ThietBiTienLamSang"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private HC_ThietBiTienLamSang()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="HC_ThietBiTienLamSang"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="HC_ThietBiTienLamSang"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.HC_ThietBiTienLamSang_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="HC_ThietBiTienLamSang"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="HC_ThietBiTienLamSang"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_ThietBiTienLamSang_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="HC_ThietBiTienLamSang"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_ThietBiTienLamSang_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="HC_ThietBiTienLamSang"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="HC_ThietBiTienLamSang"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_ThietBiTienLamSang_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
