...
//
// Filename:    HC_GiangDuong_PhieuDangKi
// ObjectType:  HC_GiangDuong_PhieuDangKi
...
namespace ModuleHanhChinh.LIB
{
    ...
    /// <summary>
    /// HC_GiangDuong_PhieuDangKi (editable root object).<br/>
    /// This is a generated base class of <see cref="HC_GiangDuong_PhieuDangKi"/> business object.
    /// </summary>
    [Serializable]
    public partial class HC_GiangDuong_PhieuDangKi : BusinessBase<HC_GiangDuong_PhieuDangKi>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="HC_GiangDuong_PhieuDangKi"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="HC_GiangDuong_PhieuDangKi"/> object.</returns>
        public static HC_GiangDuong_PhieuDangKi NewHC_GiangDuong_PhieuDangKi()
        {
            return DataPortal.Create<HC_GiangDuong_PhieuDangKi>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="HC_GiangDuong_PhieuDangKi"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the HC_GiangDuong_PhieuDangKi to fetch.</param>
        /// <returns>A reference to the fetched <see cref="HC_GiangDuong_PhieuDangKi"/> object.</returns>
        public static HC_GiangDuong_PhieuDangKi GetHC_GiangDuong_PhieuDangKi(int id)
        {
            return DataPortal.Fetch<HC_GiangDuong_PhieuDangKi>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="HC_GiangDuong_PhieuDangKi"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the HC_GiangDuong_PhieuDangKi to delete.</param>
        public static void DeleteHC_GiangDuong_PhieuDangKi(int id)
        {
            DataPortal.Delete<HC_GiangDuong_PhieuDangKi>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="HC_GiangDuong_PhieuDangKi"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewHC_GiangDuong_PhieuDangKi(EventHandler<DataPortalResult<HC_GiangDuong_PhieuDangKi>> callback)
        {
            DataPortal.BeginCreate<HC_GiangDuong_PhieuDangKi>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="HC_GiangDuong_PhieuDangKi"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the HC_GiangDuong_PhieuDangKi to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetHC_GiangDuong_PhieuDangKi(int id, EventHandler<DataPortalResult<HC_GiangDuong_PhieuDangKi>> callback)
        {
            DataPortal.BeginFetch<HC_GiangDuong_PhieuDangKi>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="HC_GiangDuong_PhieuDangKi"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the HC_GiangDuong_PhieuDangKi to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteHC_GiangDuong_PhieuDangKi(int id, EventHandler<DataPortalResult<HC_GiangDuong_PhieuDangKi>> callback)
        {
            DataPortal.BeginDelete<HC_GiangDuong_PhieuDangKi>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HC_GiangDuong_PhieuDangKi"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private HC_GiangDuong_PhieuDangKi()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="HC_GiangDuong_PhieuDangKi"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="HC_GiangDuong_PhieuDangKi"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.HC_GiangDuong_PhieuDangKi_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="HC_GiangDuong_PhieuDangKi"/> object from the given SafeDataReader.
        /// </summary>
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(GioBatDauProperty, dr.GetSmartDate("GioBatDau"));
            LoadProperty(GioKetThucProperty, dr.GetSmartDate("GioKetThuc"));
  ...
  LoadProperty(TrangThaiDuyetProperty, dr.GetString("TrangThaiDuyet"));
        ...
        /// <summary>
        /// Inserts a new <see cref="HC_GiangDuong_PhieuDangKi"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_GiangDuong_PhieuDangKi_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="HC_GiangDuong_PhieuDangKi"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_GiangDuong_PhieuDangKi_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="HC_GiangDuong_PhieuDangKi"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="HC_GiangDuong_PhieuDangKi"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_GiangDuong_PhieuDangKi_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
