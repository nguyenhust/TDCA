...
namespace Dictionary
{
    ...
    public partial class DIC_SLHocHamBV_Coll : BusinessBindingListBase<DIC_SLHocHamBV_Coll, DIC_SLHocHamBV_Info>
    {
        ...
        public static DIC_SLHocHamBV_Coll GetDIC_SLHocHamBV_Coll()
        {
            return DataPortal.Fetch<DIC_SLHocHamBV_Coll>();
        }
        ...
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void GetDIC_SLHocHamBV_Coll(EventHandler<DataPortalResult<DIC_SLHocHamBV_Coll>> callback)
        {
            DataPortal.BeginFetch<DIC_SLHocHamBV_Coll>(callback);
        }
