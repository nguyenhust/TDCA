...
//
// Filename:    DIC_Loai_Info
// ObjectType:  DIC_Loai_Info
...
namespace MyProject.Business
{
    ...
    /// <summary>
    /// DIC_Loai_Info (editable child object).<br/>
    /// This is a generated base class of <see cref="DIC_Loai_Info"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is an item of <see cref="DIC_Loai_Coll"/> collection.
    /// </remarks>
    [Serializable]
    public partial class DIC_Loai_Info : BusinessBase<DIC_Loai_Info>
    {
        ...
        internal static DIC_Loai_Info NewDIC_Loai_Info()
        {
            return DataPortal.CreateChild<DIC_Loai_Info>();
        }
        ...
        internal static void NewDIC_Loai_Info(EventHandler<DataPortalResult<DIC_Loai_Info>> callback)
        {
            DataPortal.BeginCreate<DIC_Loai_Info>(callback);
        }
        ...
        internal static DIC_Loai_Info GetDIC_Loai_Info(SafeDataReader dr)
        {
            DIC_Loai_Info obj = new DIC_Loai_Info();
        ...
        private void Child_Insert()
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_Loai_Info_Add", ctx.Connection))
                {
        ...
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_Loai_Info_Upd", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_Loai_Info_Del", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", ReadProperty(IDProperty)).DbType = DbType.Int32;
