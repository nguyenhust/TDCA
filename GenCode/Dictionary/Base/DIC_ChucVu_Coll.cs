...
//
// Filename:    DIC_ChucVu_Coll
// ObjectType:  DIC_ChucVu_Coll
...
namespace MyProject.Business
{
    ...
    /// <summary>
    /// DIC_ChucVu_Coll (editable root list).<br/>
    /// This is a generated base class of <see cref="DIC_ChucVu_Coll"/> business object.
    /// </summary>
    /// <remarks>
    /// The items of the collection are <see cref="DIC_ChucVu_Info"/> objects.
    /// </remarks>
    [Serializable]
    public partial class DIC_ChucVu_Coll : BusinessBindingListBase<DIC_ChucVu_Coll, DIC_ChucVu_Info>
    {
        ...
        {
            foreach (var dIC_ChucVu_Info in this)
            {
                if (dIC_ChucVu_Info.ID == id)
                {
                    Remove(dIC_ChucVu_Info);
                    break;
                }
            }
        }
        ...
        {
            foreach (var dIC_ChucVu_Info in this.DeletedList)
            {
                if (dIC_ChucVu_Info.ID == id)
                {
                    return true;
        ...
        public static DIC_ChucVu_Coll NewDIC_ChucVu_Coll()
        {
            return DataPortal.Create<DIC_ChucVu_Coll>();
        }
        ...
        public static DIC_ChucVu_Coll GetDIC_ChucVu_Coll()
        {
            return DataPortal.Fetch<DIC_ChucVu_Coll>();
        }
        ...
        public static void NewDIC_ChucVu_Coll(EventHandler<DataPortalResult<DIC_ChucVu_Coll>> callback)
        {
            DataPortal.BeginCreate<DIC_ChucVu_Coll>(callback);
        }
        ...
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void GetDIC_ChucVu_Coll(EventHandler<DataPortalResult<DIC_ChucVu_Coll>> callback)
        {
            DataPortal.BeginFetch<DIC_ChucVu_Coll>(callback);
        }
        ...
        protected void DataPortal_Fetch()
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_ChucVu_Coll_Get", ctx.Connection))
                {
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            while (dr.Read())
            {
                Add(DIC_ChucVu_Info.GetDIC_ChucVu_Info(dr));
            }
            RaiseListChangedEvents = rlce;
        }

        /// <summary>
        /// Updates in the database all changes made to the <see cref="DIC_ChucVu_Coll"/> object.
        /// </summary>
