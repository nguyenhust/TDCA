...
namespace TruyenThong.LIB
{
    ...
    public partial class TT_BaiViet : BusinessBase<TT_BaiViet>
    {
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(TacGiaProperty, data.TacGia);
            ...
            LoadProperty(NguoiDuyetProperty, data.NguoiDuyet);
            LoadProperty(LinkProperty, data.Link);
        ...
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.TT_BaiViet_Upd", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
