...
{
    public partial class GridHocVienChinhQuy_KetQuaTuyenSinhCKII : UsDictionary
    {
        #region variables
        ...
        public GridHocVienChinhQuy_KetQuaTuyenSinhCKII()
        {
            InitializeComponent();
            RadGrid = MasterTemplate;
            STT();
        ...
        {
            return TextMessages.ControlID.DT_HocVienChinhQuyDiemDauvaoCKII;
        }

        public override string ToString()
        {
            return TextMessages.FormTitle.DT_HocVienChinhQuyDiemDauvaoCKII;
        }
        ...
        protected override void LoadUS()
        {
            try
            {
                ...
                else
                {
                    ...
                    function.Item = DT_Common.CQ_LoaiDT_CKII;
        ...
        private void PrintCKI()
        {
            ...
            cv.E_TieuDe = new List<string>() { "Họ tên", "Ngày sinh", "Nơi sinh", "Số báo danh", "Cơ quan công tác", "Chuyên ngành dự thi", "Điểm CN", "Điểm cơ sở", "Tổng điểm" };
            ...
            foreach (Telerik.WinControls.UI.GridViewRowInfo rowInfo in RadGrid.ChildRows)
            {
                if (rowInfo.IsVisible)
                {
                    ...
                    cvItem.E_Value = new List<string>() { itemInfo.HoTen,itemInfo.NgaySinh,itemInfo.NoiSinh,itemInfo.SBD,itemInfo.NoiCongTac,itemInfo.TenChuyenNganhDuThi,itemInfo.MienThi1 == true ? "Miễn thi" : itemInfo.DauVaoDiem1.ToString(),itemInfo.MienThi2 == true ? "Miễn thi" : itemInfo.DauVaoDiem2.ToString(),itemInfo.DauVaoDiem6.ToString() };
                    cv.E_Content.Add(cvItem);
                    khoa = itemInfo.KhoaDuTuyen;
                    nam = itemInfo.NamDuTuyen.ToString();
                }
            }
            cv.E_TieuDeBaoCao = string.Format("kết quả thi tuyển chuyên khoa cấp CKII khóa {0} năm {1}", khoa, nam);
