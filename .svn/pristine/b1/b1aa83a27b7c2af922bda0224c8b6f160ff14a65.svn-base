...
namespace DanhMuc.LIB
{
    ...
    /// <summary>
    /// DIC_BenhVien_Info (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class DIC_BenhVien_Info : BusinessBase<DIC_BenhVien_Info>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="DIC_BenhVien_Info"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="DIC_BenhVien_Info"/> object.</returns>
        internal static DIC_BenhVien_Info NewDIC_BenhVien_Info()
        {
            return DataPortal.CreateChild<DIC_BenhVien_Info>();
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="DIC_BenhVien_Info"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        internal static void NewDIC_BenhVien_Info(EventHandler<DataPortalResult<DIC_BenhVien_Info>> callback)
        {
            DataPortal.BeginCreate<DIC_BenhVien_Info>(callback);
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="DIC_BenhVien_Info"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Inserts a new <see cref="DIC_BenhVien_Info"/> object in the database.
        /// </summary>
        private void Child_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_BenhVien_Info_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="DIC_BenhVien_Info"/> object.
        /// </summary>
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_BenhVien_Info_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="DIC_BenhVien_Info"/> object from database.
        /// </summary>
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_BenhVien_Info_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", ReadProperty(IDProperty)).DbType = DbType.Int64;
