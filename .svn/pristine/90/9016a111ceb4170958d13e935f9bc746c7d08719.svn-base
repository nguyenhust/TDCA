...
{
    [Serializable]
    public partial class BienLaiInfo : BusinessBase<BienLaiInfo>
    {
        #region Validation
        ...
        /// </summary>
        public static readonly PropertyInfo<Int32> IDHocVienProperty = RegisterProperty<Int32>(p => p.IDHocVien, "IDNguoi Ky Quy");
        /// <summary>
        /// ID nguoi thu ky quy
        /// </summary>
        ...
        public static BienLaiInfo NewBienLaiTamThuInfo()
        {
            //if (!CanAddObject())
            //    throw new System.Security.SecurityException("Bạn không có quyền thêm mới ký quỹ");
            return DataPortal.CreateChild<BienLaiInfo>();
        }
        ...
        internal static void NewBienLaiTamThuInfo(EventHandler<DataPortalResult<BienLaiInfo>> callback)
        {
            //if (!CanAddObject())
            //    throw new System.Security.SecurityException("Bạn không có quyền thêm mới ký quỹ");
            DataPortal.BeginCreate<BienLaiInfo>(callback);
        }
        ...
        internal static BienLaiInfo GetBienLaiTamThuInfo(SafeDataReader dr)
        {
            BienLaiInfo obj = new BienLaiInfo();
        ...
        internal static BienLaiInfo GetBienLaiTamThuInfoKQBD(SafeDataReader dr)
        {
            BienLaiInfo obj = new BienLaiInfo();
            // show the framework that this is a child object
            obj.MarkAsChild();
        ...
        internal static BienLaiInfo GetBienLaiTamThuInfoHKQ(SafeDataReader dr)
        {
            BienLaiInfo obj = new BienLaiInfo();
            // show the framework that this is a child object
            obj.MarkAsChild();
        ...
        {
            // Value properties
            LoadProperty(IDBienLaiProperty, dr.GetInt32("IDBienLai"));
