...
//
// Filename:    HC_VatTuTaiSan
// ObjectType:  HC_VatTuTaiSan
...
namespace ModuleHanhChinh.LIB
{
    ...
    /// <summary>
    /// HC_VatTuTaiSan (editable root object).<br/>
    /// This is a generated base class of <see cref="HC_VatTuTaiSan"/> business object.
    /// </summary>
    [Serializable]
    public partial class HC_VatTuTaiSan : BusinessBase<HC_VatTuTaiSan>
    {
...
/// <summary>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="HC_VatTuTaiSan"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="HC_VatTuTaiSan"/> object.</returns>
        public static HC_VatTuTaiSan NewHC_VatTuTaiSan()
        {
            return DataPortal.Create<HC_VatTuTaiSan>();
        }
        ...
        public static HC_VatTuTaiSan GetHC_VatTuTaiSan(int id)
        {
            return DataPortal.Fetch<HC_VatTuTaiSan>(id);
        }
        ...
        public static void DeleteHC_VatTuTaiSan(int id)
        {
            DataPortal.Delete<HC_VatTuTaiSan>(id);
        }
        ...
        public static void NewHC_VatTuTaiSan(EventHandler<DataPortalResult<HC_VatTuTaiSan>> callback)
        {
            DataPortal.BeginCreate<HC_VatTuTaiSan>(callback);
        }
        ...
        /// <param name="id">The ID parameter of the HC_VatTuTaiSan to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetHC_VatTuTaiSan(int id, EventHandler<DataPortalResult<HC_VatTuTaiSan>> callback)
        {
            DataPortal.BeginFetch<HC_VatTuTaiSan>(id, callback);
        }
        ...
        /// <param name="id">The ID of the HC_VatTuTaiSan to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteHC_VatTuTaiSan(int id, EventHandler<DataPortalResult<HC_VatTuTaiSan>> callback)
        {
            DataPortal.BeginDelete<HC_VatTuTaiSan>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HC_VatTuTaiSan"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private HC_VatTuTaiSan()
        {
    ...
    LoadProperty(LastEdited_UserIDProperty, dr.GetInt64("LastEdited_UserID"));
        ...
        protected override void DataPortal_Insert()
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.HC_VatTuTaiSan_add", ctx.Connection))
                {
        ...
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_VatTuTaiSan_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_VatTuTaiSan_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
