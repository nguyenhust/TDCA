...
//
// Filename:    CDT_GoiKT_Info
// ObjectType:  CDT_GoiKT_Info
...
namespace ModuleChiDaoTuyen.LIB
{
    ...
    /// <summary>
    /// CDT_GoiKT_Info (editable child object).<br/>
    /// This is a generated base class of <see cref="CDT_GoiKT_Info"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is an item of <see cref="CDT_GoiKT_Coll"/> collection.
    /// </remarks>
    [Serializable]
    public partial class CDT_GoiKT_Info : BusinessBase<CDT_GoiKT_Info>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="CDT_GoiKT_Info"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="CDT_GoiKT_Info"/> object.</returns>
        internal static CDT_GoiKT_Info NewCDT_GoiKT_Info()
        {
            return DataPortal.CreateChild<CDT_GoiKT_Info>();
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="CDT_GoiKT_Info"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        internal static void NewCDT_GoiKT_Info(EventHandler<DataPortalResult<CDT_GoiKT_Info>> callback)
        {
            DataPortal.BeginCreate<CDT_GoiKT_Info>(callback);
        }

        /// <summary>
        /// Factory method. Loads a <see cref="CDT_GoiKT_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        /// <returns>A reference to the fetched <see cref="CDT_GoiKT_Info"/> object.</returns>
        internal static CDT_GoiKT_Info GetCDT_GoiKT_Info(SafeDataReader dr)
        {
            CDT_GoiKT_Info obj = new CDT_GoiKT_Info();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CDT_GoiKT_Info"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private CDT_GoiKT_Info()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="CDT_GoiKT_Info"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="CDT_GoiKT_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        ...
        /// <summary>
        /// Inserts a new <see cref="CDT_GoiKT_Info"/> object in the database.
        /// </summary>
        private void Child_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_GoiKT_Info_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="CDT_GoiKT_Info"/> object.
        /// </summary>
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_GoiKT_Info_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="CDT_GoiKT_Info"/> object from database.
        /// </summary>
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_GoiKT_Info_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", ReadProperty(IDProperty)).DbType = DbType.Int32;
