...
namespace oldSoft
{
    ...
    /// <summary>
    /// LOP_HOC (editable root object).<br/>
    /// This is a generated base class of <see cref="LOP_HOC"/> business object.
    /// </summary>
    [Serializable]
    public partial class LOP_HOC : BusinessBase<LOP_HOC>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="LOP_HOC"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="LOP_HOC"/> object.</returns>
        public static LOP_HOC NewLOP_HOC()
        {
            return DataPortal.Create<LOP_HOC>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="LOP_HOC"/> object, based on given parameters.
        /// </summary>
        /// <param name="lOP_HOC_ID">The LOP_HOC_ID parameter of the LOP_HOC to fetch.</param>
        /// <returns>A reference to the fetched <see cref="LOP_HOC"/> object.</returns>
        public static LOP_HOC GetLOP_HOC(int lOP_HOC_ID)
        {
            return DataPortal.Fetch<LOP_HOC>(lOP_HOC_ID);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="LOP_HOC"/> object, based on given parameters.
        /// </summary>
        /// <param name="lOP_HOC_ID">The LOP_HOC_ID of the LOP_HOC to delete.</param>
        public static void DeleteLOP_HOC(int lOP_HOC_ID)
        {
            DataPortal.Delete<LOP_HOC>(lOP_HOC_ID);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="LOP_HOC"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewLOP_HOC(EventHandler<DataPortalResult<LOP_HOC>> callback)
        {
            DataPortal.BeginCreate<LOP_HOC>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="LOP_HOC"/> object, based on given parameters.
        /// </summary>
        /// <param name="lOP_HOC_ID">The LOP_HOC_ID parameter of the LOP_HOC to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetLOP_HOC(int lOP_HOC_ID, EventHandler<DataPortalResult<LOP_HOC>> callback)
        {
            DataPortal.BeginFetch<LOP_HOC>(lOP_HOC_ID, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="LOP_HOC"/> object, based on given parameters.
        /// </summary>
        /// <param name="lOP_HOC_ID">The LOP_HOC_ID of the LOP_HOC to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteLOP_HOC(int lOP_HOC_ID, EventHandler<DataPortalResult<LOP_HOC>> callback)
        {
            DataPortal.BeginDelete<LOP_HOC>(lOP_HOC_ID, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LOP_HOC"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Loads default values for the <see cref="LOP_HOC"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="LOP_HOC"/> object from the database, based on given criteria.
        /// </summary>
        /// <param name="lOP_HOC_ID">The LOP HOC ID.</param>
        protected void DataPortal_Fetch(int lOP_HOC_ID)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("Connection2"))
            {
                using (var cmd = new SqlCommand("dbo.LOP_HOC_get", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@LOP_HOC_ID", lOP_HOC_ID).DbType = DbType.Int32;
                    var args = new DataPortalHookArgs(cmd, lOP_HOC_ID);
                    OnFetchPre(args);
                    Fetch(cmd);
                    OnFetchPost(args);
                }
        ...
        /// <summary>
        /// Loads a <see cref="LOP_HOC"/> object from the given SafeDataReader.
        /// </summary>
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(NGAY_BDAUProperty, dr.GetString("NGAY_BDAU"));
            LoadProperty(NGAY_KTHUCProperty, dr.GetString("NGAY_KTHUC"));
        ...
        /// <summary>
        /// Inserts a new <see cref="LOP_HOC"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection2"))
            {
                using (var cmd = new SqlCommand("dbo.LOP_HOC_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="LOP_HOC"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection2"))
            {
                using (var cmd = new SqlCommand("dbo.LOP_HOC_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@LOP_HOC_ID", ReadProperty(LOP_HOC_IDProperty)).DbType = DbType.Int32;
        ...
        /// <summary>
        /// Self deletes the <see cref="LOP_HOC"/> object.
        /// </summary>
        protected override void DataPortal_DeleteSelf()
        {
            DataPortal_Delete(LOP_HOC_ID);
        }

        /// <summary>
        /// Deletes the <see cref="LOP_HOC"/> object from database.
        /// </summary>
        /// <param name="lOP_HOC_ID">The delete criteria.</param>
        protected void DataPortal_Delete(int lOP_HOC_ID)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection2"))
            {
                using (var cmd = new SqlCommand("dbo.LOP_HOC_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@LOP_HOC_ID", lOP_HOC_ID).DbType = DbType.Int32;
