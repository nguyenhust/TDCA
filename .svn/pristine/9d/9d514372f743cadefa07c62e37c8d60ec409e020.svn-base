...
namespace DanhMuc.LIB
{
    ...
    public partial class DIC_ChucVu_Info : BusinessBase<DIC_ChucVu_Info>
    {
        ...
        protected override void AddBusinessRules()
        {
            ...
            BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(TenProperty,"Chưa nhập tên chức vụ"));
        }
        ...
        public static void Delete_ChucVu(Int32 id)
        {
           
            DataPortal.Delete<DIC_ChucVu_Info>(id);
        }
        public static void Delete_ChucVu(Int32 id, EventHandler<DataPortalResult<DIC_ChucVu_Info>> callback)
        {
            DataPortal.BeginDelete<DIC_ChucVu_Info>(id, callback);
        }
