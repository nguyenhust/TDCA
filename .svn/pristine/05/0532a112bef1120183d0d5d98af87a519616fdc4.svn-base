...
{
    [Serializable]
    public partial class DIC_trangThaiTrangThietBi_Info : ReadOnlyBase<DIC_trangThaiTrangThietBi_Info>
    {
        ...
        internal static DIC_trangThaiTrangThietBi_Info GetDIC_trangThaiTrangThietBi_Info(SafeDataReader dr)
        {
            DIC_trangThaiTrangThietBi_Info obj = new DIC_trangThaiTrangThietBi_Info();
        ...
        public DIC_trangThaiTrangThietBi_Info()
        {
