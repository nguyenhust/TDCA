...
namespace TruyenThong.LIB
{
    ...
    /// <summary>
    /// TT_PhongVan_Info (editable child object).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class TT_PhongVan_Info : BusinessBase<TT_PhongVan_Info>
    {
        ...
        /// Maintains metadata about <see cref="SoDienThoai"/> property.
        /// </summary>
        public static readonly PropertyInfo<string> TenCoQuanProperty = RegisterProperty<string>(p => p.TenCoQuan, "TenCoQuan");
        /// <summary>
        /// Gets or sets the So Dien Thoai.
        /// </summary>
        /// <value>The So Dien Thoai.</value>
        ...
        {
            get { return GetProperty(TenCoQuanProperty); }
            set { SetProperty(TenCoQuanProperty, value); }
        }
        /// <summary>
        /// Maintains metadata about <see cref="SoDienThoai"/> property.
        /// </summary>
        public static readonly PropertyInfo<string> TenKhoaProperty = RegisterProperty<string>(p => p.TenKhoa, "TenKhoa");
        /// <summary>
        /// Gets or sets the So Dien Thoai.
        /// </summary>
        /// <value>The So Dien Thoai.</value>
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="TT_PhongVan_Info"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="TT_PhongVan_Info"/> object.</returns>
        internal static TT_PhongVan_Info NewTT_PhongVan_Info()
        {
            return DataPortal.CreateChild<TT_PhongVan_Info>();
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="TT_PhongVan_Info"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        internal static void NewTT_PhongVan_Info(EventHandler<DataPortalResult<TT_PhongVan_Info>> callback)
        {
            DataPortal.BeginCreate<TT_PhongVan_Info>(callback);
        }
        ...
        /// <summary>
        /// Loads default values for the <see cref="TT_PhongVan_Info"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        protected override void Child_Create()
        {
            ...
            LoadProperty(TenKhoaProperty, null);
            LoadProperty(TenCoQuanProperty, null);
 LoadProperty(TenPhongVienProperty, null);
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(TenCoQuanProperty, dr.GetString("TenCoQuan"));
        ...
        /// <summary>
        /// Inserts a new <see cref="TT_PhongVan_Info"/> object in the database.
        /// </summary>
        private void Child_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.TT_PhongVan_Info_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="TT_PhongVan_Info"/> object.
        /// </summary>
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.TT_PhongVan_Info_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="TT_PhongVan_Info"/> object from database.
        /// </summary>
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.TT_PhongVan_Info_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", ReadProperty(IDProperty)).DbType = DbType.Int64;
