...
{
    public partial class Grid_NhapXuatVanPhongPham : UsDictionary
    {
        private HC_DuTruVanPhongPham_NhapXuat_Coll listItem;
        private HC_DuTruVanPhongPham_NhapXuat_Info item;
        private FormMode formMode = new FormMode();
        public Grid_NhapXuatVanPhongPham()
        {
            InitializeComponent();
        ...
        {
            return TextMessages.ControlID.HC_DuTruVanPhongPham_NhapXuat;
        }

        public override string ToString()
        {
            return TextMessages.FormTitle.HC_DuTruVanPhongPham_NhapXuat;
        }

        protected override void ApplyAuthorizationRules()
        {
            bl_btnSave = GlobalCommon.IsHavePermission(TextMessages.RolePermission.HC_VanPhongPham_NhapXuat_Insert);
            bl_btnPrint = GlobalCommon.IsHavePermission(TextMessages.RolePermission.HC_VanPhongPham_NhapXuat_Print);
            bl_btnMyClose = true;
            bl_btnDelete = GlobalCommon.IsHavePermission(TextMessages.RolePermission.HC_VanPhongPham_NhapXuat_Delete);
        }
        ...
        protected override void Save()
        {
            try
            {
                ...
                Form_VanPhongPham_NhapXuat fr = new Form_VanPhongPham_NhapXuat(formMode);
                fr.ShowDialog();
                LoadUS();
        ...
        private void PrintThongKeTonKho()
        {
            ...
            cv.E_TieuDe = new List<string>() { "Vật tư sản phẩm", "Nhập", "Xuất", "Tồn" };
            //string temp = string.Empty;
           // HC_DuTruVanPhongPham_Coll cvColl = (HC_DuTruVanPhongPham_Coll)bindingSourceThietbi.DataSource;
            foreach (Telerik.WinControls.UI.GridViewRowInfo rowInfo in radGridViewTonKho.ChildRows)
            {
                if (rowInfo.IsVisible)
                {
                    ...
                    HC_DuTruVanPhongPham_NhapXuat_Info itemInfo = (HC_DuTruVanPhongPham_NhapXuat_Info)rowInfo.DataBoundItem;
            ...
            cv.E_TieuDeBaoCao = "Danh sách tồn kho Văn phòng phẩm";
        ...
        private void GridViewNhapKho_CellDoubleClick(object sender, Telerik.WinControls.UI.GridViewCellEventArgs e)
        {
            try
            {
                if (int.TryParse(GridViewNhapKho.CurrentRow.Cells["Id"].Value.ToString(), out selectedID)
                    && GlobalCommon.IsHavePermission(new string[] { TextMessages.RolePermission.HC_VanPhongPham_NhapXuat_Edit, TextMessages.RolePermission.HC_VanPhongPham_NhapXuat_View }))
                {
