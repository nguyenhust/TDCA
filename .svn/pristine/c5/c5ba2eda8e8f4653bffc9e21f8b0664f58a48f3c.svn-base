...
//
// Filename:    DT_ChinhQuy_LopHoc
// ObjectType:  DT_ChinhQuy_LopHoc
...
namespace ModuleDaoTao.LIB
{
    ...
    /// <summary>
    /// DT_ChinhQuy_LopHoc (editable root object).<br/>
    /// This is a generated base class of <see cref="DT_ChinhQuy_LopHoc"/> business object.
    /// </summary>
    [Serializable]
    public partial class DT_ChinhQuy_LopHoc : BusinessBase<DT_ChinhQuy_LopHoc>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="DT_ChinhQuy_LopHoc"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="DT_ChinhQuy_LopHoc"/> object.</returns>
        public static DT_ChinhQuy_LopHoc NewDT_ChinhQuy_LopHoc()
        {
            return DataPortal.Create<DT_ChinhQuy_LopHoc>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="DT_ChinhQuy_LopHoc"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the DT_ChinhQuy_LopHoc to fetch.</param>
        /// <returns>A reference to the fetched <see cref="DT_ChinhQuy_LopHoc"/> object.</returns>
        public static DT_ChinhQuy_LopHoc GetDT_ChinhQuy_LopHoc(int id)
        {
            return DataPortal.Fetch<DT_ChinhQuy_LopHoc>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="DT_ChinhQuy_LopHoc"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the DT_ChinhQuy_LopHoc to delete.</param>
        public static void DeleteDT_ChinhQuy_LopHoc(int id)
        {
            DataPortal.Delete<DT_ChinhQuy_LopHoc>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="DT_ChinhQuy_LopHoc"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewDT_ChinhQuy_LopHoc(EventHandler<DataPortalResult<DT_ChinhQuy_LopHoc>> callback)
        {
            DataPortal.BeginCreate<DT_ChinhQuy_LopHoc>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="DT_ChinhQuy_LopHoc"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the DT_ChinhQuy_LopHoc to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetDT_ChinhQuy_LopHoc(int id, EventHandler<DataPortalResult<DT_ChinhQuy_LopHoc>> callback)
        {
            DataPortal.BeginFetch<DT_ChinhQuy_LopHoc>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="DT_ChinhQuy_LopHoc"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the DT_ChinhQuy_LopHoc to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteDT_ChinhQuy_LopHoc(int id, EventHandler<DataPortalResult<DT_ChinhQuy_LopHoc>> callback)
        {
            DataPortal.BeginDelete<DT_ChinhQuy_LopHoc>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DT_ChinhQuy_LopHoc"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private DT_ChinhQuy_LopHoc()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="DT_ChinhQuy_LopHoc"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="DT_ChinhQuy_LopHoc"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DT_ChinhQuy_LopHoc_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="DT_ChinhQuy_LopHoc"/> object from the given SafeDataReader.
        /// </summary>
 ...
 LoadProperty(TongTienHocProperty, dr.GetInt32("TongTienHoc"));
        ...
        /// <summary>
        /// Inserts a new <see cref="DT_ChinhQuy_LopHoc"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DT_ChinhQuy_LopHoc_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="DT_ChinhQuy_LopHoc"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DT_ChinhQuy_LopHoc_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="DT_ChinhQuy_LopHoc"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="DT_ChinhQuy_LopHoc"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DT_ChinhQuy_LopHoc_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
