...
//
// Filename:    HC_CongVanDen
// ObjectType:  HC_CongVanDen
...
namespace ModuleHanhChinh.LIB
{
    ...
    /// <summary>
    /// HC_CongVanDen (editable root object).<br/>
    /// This is a generated base class of <see cref="HC_CongVanDen"/> business object.
    /// </summary>
    [Serializable]
    public partial class HC_CongVanDen : BusinessBase<HC_CongVanDen>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="HC_CongVanDen"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="HC_CongVanDen"/> object.</returns>
        public static HC_CongVanDen NewHC_CongVanDen()
        {
            return DataPortal.Create<HC_CongVanDen>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="HC_CongVanDen"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the HC_CongVanDen to fetch.</param>
        /// <returns>A reference to the fetched <see cref="HC_CongVanDen"/> object.</returns>
        public static HC_CongVanDen GetHC_CongVanDen(int id)
        {
            return DataPortal.Fetch<HC_CongVanDen>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="HC_CongVanDen"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the HC_CongVanDen to delete.</param>
        public static void DeleteHC_CongVanDen(int id)
        {
            DataPortal.Delete<HC_CongVanDen>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="HC_CongVanDen"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewHC_CongVanDen(EventHandler<DataPortalResult<HC_CongVanDen>> callback)
        {
            DataPortal.BeginCreate<HC_CongVanDen>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="HC_CongVanDen"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the HC_CongVanDen to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetHC_CongVanDen(int id, EventHandler<DataPortalResult<HC_CongVanDen>> callback)
        {
            DataPortal.BeginFetch<HC_CongVanDen>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="HC_CongVanDen"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the HC_CongVanDen to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteHC_CongVanDen(int id, EventHandler<DataPortalResult<HC_CongVanDen>> callback)
        {
            DataPortal.BeginDelete<HC_CongVanDen>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HC_CongVanDen"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private HC_CongVanDen()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="HC_CongVanDen"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="HC_CongVanDen"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.HC_CongVanDen_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="HC_CongVanDen"/> object from the given SafeDataReader.
        /// </summary>
    ...
    LoadProperty(LastEdited_UserIDProperty, dr.GetInt64("LastEdited_UserID"));
        ...
        /// <summary>
        /// Inserts a new <see cref="HC_CongVanDen"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_CongVanDen_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="HC_CongVanDen"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_CongVanDen_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="HC_CongVanDen"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="HC_CongVanDen"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_CongVanDen_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
