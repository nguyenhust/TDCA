...
//
// Filename:    HC_GiangDuong_Phong
// ObjectType:  HC_GiangDuong_Phong
...
namespace ModuleHanhChinh.LIB
{
    ...
    /// <summary>
    /// HC_GiangDuong_Phong (editable root object).<br/>
    /// This is a generated base class of <see cref="HC_GiangDuong_Phong"/> business object.
    /// </summary>
    [Serializable]
    public partial class HC_GiangDuong_Phong : BusinessBase<HC_GiangDuong_Phong>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="HC_GiangDuong_Phong"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="HC_GiangDuong_Phong"/> object.</returns>
        public static HC_GiangDuong_Phong NewHC_GiangDuong_Phong()
        {
            return DataPortal.Create<HC_GiangDuong_Phong>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="HC_GiangDuong_Phong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the HC_GiangDuong_Phong to fetch.</param>
        /// <returns>A reference to the fetched <see cref="HC_GiangDuong_Phong"/> object.</returns>
        public static HC_GiangDuong_Phong GetHC_GiangDuong_Phong(int id)
        {
            return DataPortal.Fetch<HC_GiangDuong_Phong>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="HC_GiangDuong_Phong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the HC_GiangDuong_Phong to delete.</param>
        public static void DeleteHC_GiangDuong_Phong(int id)
        {
            DataPortal.Delete<HC_GiangDuong_Phong>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="HC_GiangDuong_Phong"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewHC_GiangDuong_Phong(EventHandler<DataPortalResult<HC_GiangDuong_Phong>> callback)
        {
            DataPortal.BeginCreate<HC_GiangDuong_Phong>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="HC_GiangDuong_Phong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the HC_GiangDuong_Phong to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetHC_GiangDuong_Phong(int id, EventHandler<DataPortalResult<HC_GiangDuong_Phong>> callback)
        {
            DataPortal.BeginFetch<HC_GiangDuong_Phong>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="HC_GiangDuong_Phong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the HC_GiangDuong_Phong to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteHC_GiangDuong_Phong(int id, EventHandler<DataPortalResult<HC_GiangDuong_Phong>> callback)
        {
            DataPortal.BeginDelete<HC_GiangDuong_Phong>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HC_GiangDuong_Phong"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private HC_GiangDuong_Phong()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="HC_GiangDuong_Phong"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="HC_GiangDuong_Phong"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.HC_GiangDuong_Phong_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="HC_GiangDuong_Phong"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="HC_GiangDuong_Phong"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_GiangDuong_Phong_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="HC_GiangDuong_Phong"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_GiangDuong_Phong_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="HC_GiangDuong_Phong"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="HC_GiangDuong_Phong"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_GiangDuong_Phong_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
