...
namespace DanhMuc.LIB
{
    ...
    public partial class DIC_TinhChild_Coll : BusinessBindingListBase<DIC_TinhChild_Coll, DIC_TinhChild_Info>
    {
        ...
        internal static DIC_TinhChild_Coll GetDIC_TinhChild_Coll()
        {
            return DataPortal.Fetch<DIC_TinhChild_Coll>();
        }

        internal static void GetDIC_TinhChild_Coll(EventHandler<DataPortalResult<DIC_TinhChild_Coll>> callback)
        {
            DataPortal.BeginCreate<DIC_TinhChild_Coll>(callback);
        }

        internal static DIC_TinhChild_Coll GetDIC_TinhChild_Coll(Int64 id)
        {
            return DataPortal.Fetch<DIC_TinhChild_Coll>(id);
        }

        internal static void GetDIC_TinhChild_Coll(Int64 id, EventHandler<DataPortalResult<DIC_TinhChild_Coll>> callback)
        {
            DataPortal.BeginFetch<DIC_TinhChild_Coll>(id, callback);
        }
        /// <summary>
        ...
        protected void DataPortal_Fetch()
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_Tinh_GetTinh", ctx.Connection))
                {
        ...
        protected void DataPortal_Fetch(Int64 id)
        {
            using (var ctx = ConnectionManager<SqlConnection>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_TinhCon_Get", ctx.Connection))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
