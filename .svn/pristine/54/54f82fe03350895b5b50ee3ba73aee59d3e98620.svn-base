    ...
    public class VNRadGridLP : RadGridLocalizationProvider
    {
        public override string GetLocalizedString(string id)
        {
            switch (id)
            {
                ...
                case RadGridStringId.FilterOperatorIsContainedIn: return "Chứ trong";
                ...
                case RadGridStringId.DeleteRowMenuItem: return "Xóa bản nghi";
                ...
                case RadGridStringId.UnpinRowMenuItem: return "Chốt bản nghi";
                ...
                case RadGridStringId.AddNewRowString: return "Click thêm mới bản nghi";
