...
namespace DanhMuc.LIB
{
    ...
    public partial class DIC_GioiTInh_Info : BusinessBase<DIC_GioiTInh_Info>
    {
        ...
        protected override void AddBusinessRules()
        {
            ...
            BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(TenProperty, "Giới tính không thể thiếu"));
        }
        #endregion
        ...
        //{
        //    base.AddBusinessRules();
        //    BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(TenProperty,"Chưa nhập Tên giới tính"));
        //}
        #endregion
