...
{
    public partial class DropDownLoai : RadMultiColumnComboBox
    {
        DIC_Loai_Coll listItem;
        public DropDownLoai()
        {
            InitializeComponent();
            this.Text = string.Empty;
            this.NullText = "Chọn Loại";
        }
        ...
        private void BindData()
        {
            ...
            gridViewControl.Columns[columnVisible].HeaderText = "Loại";
            gridViewControl.MasterTemplate.AutoGenerateColumns = false;
            gridViewControl.MasterTemplate.AutoSizeColumnsMode = GridViewAutoSizeColumnsMode.Fill;
        ...
        {
            object obj = GlobalCommon.CacheReader(TextMessages.CacheID.DIC_Loai + STT.ToString());
            if (obj != null)
            {
                FillData(((DIC_Loai_Coll)obj));
            }
            else
            {

                listItem = DIC_Loai_Coll.GetDIC_Loai_Coll();
                GlobalCommon.CacheWriter(TextMessages.CacheID.DIC_Loai + STT.ToString(), listItem);
                BindData();
            }
        ...
        public void FillData(DIC_Loai_Coll Loai)
        {
            this.listItem = Loai;
            BindData();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public DIC_Loai_Coll GetListData()
        {
            return listItem;
        }
        /// <summary>
