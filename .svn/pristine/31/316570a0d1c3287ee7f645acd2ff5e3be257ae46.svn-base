...
{
    [Serializable]
    public partial class DIC_GiangVien_Info:BusinessBase<DIC_GiangVien_Info>
    {
        ...
        public static readonly PropertyInfo<string> TenHocHamProperty = RegisterProperty<string>(p => p.TenHocHam, "Ten Bo Phan");
        /// <summary>
        /// Gets or sets the Noi Cap.
        /// </summary>
        /// <value>The Noi Cap.</value>
        ...
        public static readonly PropertyInfo<string> TenChuyenNganhProperty = RegisterProperty<string>(p => p.TenChuyenNganh, "Ten Bo Phan");
        /// <summary>
        /// Gets or sets the Noi Cap.
        /// </summary>
        /// <value>The Noi Cap.</value>
        ...
        {
            get { return string.Format("{0} {1} {2} ", GetProperty(TenBoPhanProperty),GetProperty(TenChucVuProperty)); }
        }


        public static readonly PropertyInfo<string> ChungChiProperty = RegisterProperty<string>(p => p.ChungChi, "Ten Bo Phan");
        /// <summary>
        /// Gets or sets the Noi Cap.
        /// </summary>
        /// <value>The Noi Cap.</value>
        ...
        public static readonly PropertyInfo<string> ChuyenKhoaProperty = RegisterProperty<string>(p => p.ChuyenKhoa, "Ten chuc Vu");
        /// <summary>
        /// Gets or sets the Email.
        /// </summary>
        /// <value>The Email.</value>
        ...
        internal static DIC_GiangVien_Info NewDIC_GiangVien_Info()
        {
            return DataPortal.CreateChild<DIC_GiangVien_Info>();
        }
        ...
        internal static void NewDIC_GiangVien_Info(EventHandler<DataPortalResult<DIC_GiangVien_Info>> callback)
        {
            DataPortal.BeginCreate<DIC_GiangVien_Info>(callback);
        }
        ...
        internal static DIC_GiangVien_Info GetDIC_GiangVien_Info(SafeDataReader dr)
        {
            DIC_GiangVien_Info obj = new DIC_GiangVien_Info();
  ...
  LoadProperty(GhiChuProperty, null);         
        ...
        private void Fetch(SafeDataReader dr)
        {
              ...
              //  LoadProperty(IDBoPhanProperty, dr.GetInt32("IDBoPhan"));
                ...
                LoadProperty(TenTrinhDoProperty, dr.GetString("TenHocVi"));
                LoadProperty(TenChucVuProperty, dr.GetString("TenChucVu"));
                LoadProperty(TenTinhProperty, dr.GetString("TenTinhThanh"));
        ...
        private void Child_Insert()
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_GiangVien_Info_add", ctx.Connection))
                {
        ...
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_GiangVien_Info_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_GiangVien_Info_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", ReadProperty(IDProperty)).DbType = DbType.Int64;
