...
namespace DanhMuc.LIB
{
    ...
    public partial class DIC_VatTu : BusinessBase<DIC_VatTu>
    {
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(IDDonViTinhProperty, dr.GetInt32("IDDonViTinh"));
            LoadProperty(MauSacProperty, dr.GetString("MauSac"));
            LoadProperty(NhaSXProperty, dr.GetString("NhaSX"));
            LoadProperty(NguonGocXuatXuProperty, dr.GetString("NguonGocXuatXu"));
            LoadProperty(DonGiaProperty, dr.GetDecimal("DonGia"));
            LoadProperty(PhuKienProperty, dr.GetString("PhuKien"));
            LoadProperty(SerialProperty, dr.GetString("Serial"));
