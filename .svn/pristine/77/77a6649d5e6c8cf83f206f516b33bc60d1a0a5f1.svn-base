...
//
// Filename:    HC_NhanVien_ChamCong
// ObjectType:  HC_NhanVien_ChamCong
...
namespace ModuleHanhChinh.LIB
{
    ...
    /// <summary>
    /// HC_NhanVien_ChamCong (editable root object).<br/>
    /// This is a generated base class of <see cref="HC_NhanVien_ChamCong"/> business object.
    /// </summary>
    [Serializable]
    public partial class HC_NhanVien_ChamCong : BusinessBase<HC_NhanVien_ChamCong>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="HC_NhanVien_ChamCong"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="HC_NhanVien_ChamCong"/> object.</returns>
        public static HC_NhanVien_ChamCong NewHC_NhanVien_ChamCong()
        {
            return DataPortal.Create<HC_NhanVien_ChamCong>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="HC_NhanVien_ChamCong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The Id parameter of the HC_NhanVien_ChamCong to fetch.</param>
        /// <returns>A reference to the fetched <see cref="HC_NhanVien_ChamCong"/> object.</returns>
        public static HC_NhanVien_ChamCong GetHC_NhanVien_ChamCong(int id)
        {
            return DataPortal.Fetch<HC_NhanVien_ChamCong>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="HC_NhanVien_ChamCong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The Id of the HC_NhanVien_ChamCong to delete.</param>
        public static void DeleteHC_NhanVien_ChamCong(int id)
        {
            DataPortal.Delete<HC_NhanVien_ChamCong>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="HC_NhanVien_ChamCong"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewHC_NhanVien_ChamCong(EventHandler<DataPortalResult<HC_NhanVien_ChamCong>> callback)
        {
            DataPortal.BeginCreate<HC_NhanVien_ChamCong>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="HC_NhanVien_ChamCong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The Id parameter of the HC_NhanVien_ChamCong to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetHC_NhanVien_ChamCong(int id, EventHandler<DataPortalResult<HC_NhanVien_ChamCong>> callback)
        {
            DataPortal.BeginFetch<HC_NhanVien_ChamCong>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="HC_NhanVien_ChamCong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The Id of the HC_NhanVien_ChamCong to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteHC_NhanVien_ChamCong(int id, EventHandler<DataPortalResult<HC_NhanVien_ChamCong>> callback)
        {
            DataPortal.BeginDelete<HC_NhanVien_ChamCong>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HC_NhanVien_ChamCong"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private HC_NhanVien_ChamCong()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="HC_NhanVien_ChamCong"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="HC_NhanVien_ChamCong"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.HC_NhanVien_ChamCong_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="HC_NhanVien_ChamCong"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="HC_NhanVien_ChamCong"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_NhanVien_ChamCong_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="HC_NhanVien_ChamCong"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_NhanVien_ChamCong_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    cmd.Parameters.AddWithValue("@TCA2", ReadProperty(TCA2Property) == null ? (object)DBNull.Value : ReadProperty(TCA2Property).Value).DbType = DbType.Double;
                    cmd.Parameters.AddWithValue("@KyHieu", ReadProperty(KyHieuProperty) == null ? (object)DBNull.Value : ReadProperty(KyHieuProperty)).DbType = DbType.String;
                    cmd.Parameters.AddWithValue("@TenNhanVien", ReadProperty(TenNhanVienProperty) == null ? (object)DBNull.Value : ReadProperty(TenNhanVienProperty)).DbType = DbType.String;
                    var args = new DataPortalHookArgs(cmd);
                    OnUpdatePre(args);
                    cmd.ExecuteNonQuery();
                    OnUpdatePost(args);
        ...
        /// <summary>
        /// Self deletes the <see cref="HC_NhanVien_ChamCong"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="HC_NhanVien_ChamCong"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.HC_NhanVien_ChamCong_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Id", id).DbType = DbType.Int32;
