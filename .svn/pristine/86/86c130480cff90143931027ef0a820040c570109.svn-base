...
namespace DanhMuc.LIB
{
    ...
    /// <summary>
    /// DIC_Phong (editable root object).<br/>
    /// This is a generated base class of <see cref="DIC_Phong"/> business object.
    /// </summary>
    [Serializable]
    public partial class DIC_Phong : BusinessBase<DIC_Phong>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="DIC_Phong"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="DIC_Phong"/> object.</returns>
        public static DIC_Phong NewDIC_Phong()
        {
            return DataPortal.Create<DIC_Phong>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="DIC_Phong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the DIC_Phong to fetch.</param>
        /// <returns>A reference to the fetched <see cref="DIC_Phong"/> object.</returns>
        public static DIC_Phong GetDIC_Phong(int id)
        {
            return DataPortal.Fetch<DIC_Phong>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="DIC_Phong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the DIC_Phong to delete.</param>
        public static void DeleteDIC_Phong(int id)
        {
            DataPortal.Delete<DIC_Phong>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="DIC_Phong"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewDIC_Phong(EventHandler<DataPortalResult<DIC_Phong>> callback)
        {
            DataPortal.BeginCreate<DIC_Phong>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="DIC_Phong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the DIC_Phong to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetDIC_Phong(int id, EventHandler<DataPortalResult<DIC_Phong>> callback)
        {
            DataPortal.BeginFetch<DIC_Phong>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="DIC_Phong"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the DIC_Phong to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteDIC_Phong(int id, EventHandler<DataPortalResult<DIC_Phong>> callback)
        {
            DataPortal.BeginDelete<DIC_Phong>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DIC_Phong"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Loads default values for the <see cref="DIC_Phong"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="DIC_Phong"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_Phong_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="DIC_Phong"/> object from the given SafeDataReader.
        /// </summary>
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(IDCanBoProperty, dr.GetInt32("IDCanBo"));
            LoadProperty(TinhTrangProperty, dr.GetString("TinhTrang"));
            LoadProperty(MucDichProperty, dr.GetString("MucDich"));
            ...
            LoadProperty(SucChuaProperty, dr.GetBoolean("SucChua"));
            LoadProperty(TrangThietBiProperty, dr.GetString("TrangThietBi"));
            var args = new DataPortalHookArgs(dr);
            OnFetchRead(args);
        }

        /// <summary>
        /// Inserts a new <see cref="DIC_Phong"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_Phong_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="DIC_Phong"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_Phong_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="DIC_Phong"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="DIC_Phong"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_Phong_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
