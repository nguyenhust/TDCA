...
{
    public partial class GridHocVienChinhQuyKetQuaTuyenSinhCKI : UsDictionary
    {
        #region variables
        ...
        public GridHocVienChinhQuyKetQuaTuyenSinhCKI()
        {
            InitializeComponent();
            RadGrid = radGridView;
            STT();
        ...
        {
            return TextMessages.ControlID.DT_HocVienChinhQuyDiemDauvaoCKI;
        }

        public override string ToString()
        {
            return TextMessages.FormTitle.DT_HocVienChinhQuyDiemDauvaoCKI;
        }
        ...
        protected override void LoadUS()
        {
            try
            {
                ...
                else
                {
                    ...
                    function.Item = DT_Common.CQ_LoaiDT_CKI;
        ...
        private void PrintCKI()
        {
            ...
            cv.E_TieuDeBaoCao = string.Format("kết quả thi tuyển chuyên khoa cấp CKI khóa {0} năm {1}", khoa, nam);
