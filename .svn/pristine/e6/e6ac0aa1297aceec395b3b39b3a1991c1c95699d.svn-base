...
//
// Filename:    DIC_BoPhan_Info
// ObjectType:  DIC_BoPhan_Info
...
namespace DanhMuc.LIB
{
    ...
    /// <summary>
    /// DIC_BoPhan_Info (editable child object).<br/>
    /// This is a generated base class of <see cref="DIC_BoPhan_Info"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is an item of <see cref="DIC_BoPhan_Coll"/> collection.
    /// </remarks>
    [Serializable]
    public partial class DIC_BoPhan_Info : BusinessBase<DIC_BoPhan_Info>
    {
        ...
        protected override void AddBusinessRules()
        {
            ...
            BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(TenProperty, "Tên bộ phận không thể thiếu"));
        }
        #endregion
        ...
        //{
        //    base.AddBusinessRules();
        //    BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(TenProperty, "Chưa nhập Tên"));
        //    BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(MaProperty,"Chưa nhập mã"));
        //}
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="DIC_BoPhan_Info"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="DIC_BoPhan_Info"/> object.</returns>
        internal static DIC_BoPhan_Info NewDIC_BoPhan_Info()
        {
            return DataPortal.CreateChild<DIC_BoPhan_Info>();
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="DIC_BoPhan_Info"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        internal static void NewDIC_BoPhan_Info(EventHandler<DataPortalResult<DIC_BoPhan_Info>> callback)
        {
            DataPortal.BeginCreate<DIC_BoPhan_Info>(callback);
        }

        /// <summary>
        /// Factory method. Loads a <see cref="DIC_BoPhan_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        /// <returns>A reference to the fetched <see cref="DIC_BoPhan_Info"/> object.</returns>
        internal static DIC_BoPhan_Info GetDIC_BoPhan_Info(SafeDataReader dr)
        {
            DIC_BoPhan_Info obj = new DIC_BoPhan_Info();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DIC_BoPhan_Info"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        public DIC_BoPhan_Info()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="DIC_BoPhan_Info"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="DIC_BoPhan_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        ...
        /// <summary>
        /// Inserts a new <see cref="DIC_BoPhan_Info"/> object in the database.
        /// </summary>
        private void Child_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_BoPhan_Info_Add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="DIC_BoPhan_Info"/> object.
        /// </summary>
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_BoPhan_Info_Upd", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="DIC_BoPhan_Info"/> object from database.
        /// </summary>
