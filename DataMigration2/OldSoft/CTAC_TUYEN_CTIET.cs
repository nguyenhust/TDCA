...
//
// Filename:    CTAC_TUYEN_CTIET
// ObjectType:  CTAC_TUYEN_CTIET
...
namespace oldSoft
{
    ...
    /// <summary>
    /// CTAC_TUYEN_CTIET (editable root object).<br/>
    /// This is a generated base class of <see cref="CTAC_TUYEN_CTIET"/> business object.
    /// </summary>
    [Serializable]
    public partial class CTAC_TUYEN_CTIET : BusinessBase<CTAC_TUYEN_CTIET>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CTAC_TUYEN_CTIET"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private CTAC_TUYEN_CTIET()
        {
        ...
        /// <summary>
        /// Loads a <see cref="CTAC_TUYEN_CTIET"/> object from the given SafeDataReader.
        /// </summary>
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            //LoadProperty(NGAY_BDAUProperty, data.NGAY_BDAU);
            //LoadProperty(NGAY_KTHUCProperty, data.NGAY_KTHUC);
            //LoadProperty(MA_LOAIHINHProperty, data.MA_LOAIHINH);
            //LoadProperty(NOI_DUNGProperty, data.NOI_DUNG);
            //LoadProperty(GHI_CHUProperty, data.GHI_CHU);
            //LoadProperty(MA_BOPHAN_IDProperty, data.MA_BOPHAN_ID);
            //LoadProperty(TEN_CBProperty, data.TEN_CB);
            //LoadProperty(CHUC_VUProperty, data.CHUC_VU);
            //LoadProperty(TRINH_DOProperty, data.TRINH_DO);
            //LoadProperty(NAM_SINHCBProperty, data.NAM_SINHCB);
            //LoadProperty(SO_QDProperty, data.SO_QD);
            var args = new DataPortalHookArgs(dr);
            OnFetchRead(args);
        }

        /// <summary>
        /// Inserts a new <see cref="CTAC_TUYEN_CTIET"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection2"))
            {
                using (var cmd = new SqlCommand("dbo.CTAC_TUYEN_CTIET_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="CTAC_TUYEN_CTIET"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection2"))
            {
                using (var cmd = new SqlCommand("dbo.CTAC_TUYEN_CTIET_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@CTAC_TUYEN_CTIET_ID", ReadProperty(CTAC_TUYEN_CTIET_IDProperty)).DbType = DbType.Int32;
