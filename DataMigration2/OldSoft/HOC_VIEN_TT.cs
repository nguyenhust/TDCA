...
//
// Filename:    HOC_VIEN_TT
// ObjectType:  HOC_VIEN_TT
...
namespace oldSoft
{
    ...
    /// <summary>
    /// HOC_VIEN_TT (editable root object).<br/>
    /// This is a generated base class of <see cref="HOC_VIEN_TT"/> business object.
    /// </summary>
    [Serializable]
    public partial class HOC_VIEN_TT : BusinessBase<HOC_VIEN_TT>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<int?> LOP_DK_IDProperty = RegisterProperty<int?>(p => p.LOP_DK_ID, "LOP DK ID", null);
        /// <summary>
        /// CDT.HV_DAOTAO.LOP_DK_ID
        /// </summary>
        /// <value>The LOP DK ID.</value>
        public int? LOP_DK_ID
        {
        ...
        /// </summary>
        public static readonly PropertyInfo<int?> CK_DK_IDProperty = RegisterProperty<int?>(p => p.CK_DK_ID, "CK DK ID", null);
        /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<int?> UU_TIENProperty = RegisterProperty<int?>(p => p.UU_TIEN, "UU TIEN", null);
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HOC_VIEN_TT"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Loads a <see cref="HOC_VIEN_TT"/> object from the given SafeDataReader.
        /// </summary>
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(MA_TPHOProperty, dr.GetInt32("MA_TPHO"));
            ...
            LoadProperty(LOP_DK_IDProperty, dr.GetInt32("LOP_DK_ID"));
            LoadProperty(CK_DK_IDProperty,  dr.GetInt32("CK_DK_ID"));
        ...
        /// <summary>
        /// Inserts a new <see cref="HOC_VIEN_TT"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection2"))
            {
                using (var cmd = new SqlCommand("dbo.HOC_VIEN_TT_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="HOC_VIEN_TT"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection2"))
            {
                using (var cmd = new SqlCommand("dbo.HOC_VIEN_TT_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@HOC_VIEN_TT_ID", ReadProperty(HOC_VIEN_TT_IDProperty)).DbType = DbType.Int32;
