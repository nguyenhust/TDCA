...
//
// Filename:    CDT_HopDongCGKT
// ObjectType:  CDT_HopDongCGKT
...
namespace ModuleChiDaoTuyen.LIB
{
    ...
    /// <summary>
    /// CDT_HopDongCGKT (editable root object).<br/>
    /// This is a generated base class of <see cref="CDT_HopDongCGKT"/> business object.
    /// </summary>
    [Serializable]
    public partial class CDT_HopDongCGKT : BusinessBase<CDT_HopDongCGKT>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="CDT_HopDongCGKT"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="CDT_HopDongCGKT"/> object.</returns>
        public static CDT_HopDongCGKT NewCDT_HopDongCGKT()
        {
            return DataPortal.Create<CDT_HopDongCGKT>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="CDT_HopDongCGKT"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the CDT_HopDongCGKT to fetch.</param>
        /// <returns>A reference to the fetched <see cref="CDT_HopDongCGKT"/> object.</returns>
        public static CDT_HopDongCGKT GetCDT_HopDongCGKT(int id)
        {
            return DataPortal.Fetch<CDT_HopDongCGKT>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="CDT_HopDongCGKT"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the CDT_HopDongCGKT to delete.</param>
        public static void DeleteCDT_HopDongCGKT(int id)
        {
            DataPortal.Delete<CDT_HopDongCGKT>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="CDT_HopDongCGKT"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewCDT_HopDongCGKT(EventHandler<DataPortalResult<CDT_HopDongCGKT>> callback)
        {
            DataPortal.BeginCreate<CDT_HopDongCGKT>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="CDT_HopDongCGKT"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the CDT_HopDongCGKT to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetCDT_HopDongCGKT(int id, EventHandler<DataPortalResult<CDT_HopDongCGKT>> callback)
        {
            DataPortal.BeginFetch<CDT_HopDongCGKT>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="CDT_HopDongCGKT"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the CDT_HopDongCGKT to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteCDT_HopDongCGKT(int id, EventHandler<DataPortalResult<CDT_HopDongCGKT>> callback)
        {
            DataPortal.BeginDelete<CDT_HopDongCGKT>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CDT_HopDongCGKT"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private CDT_HopDongCGKT()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="CDT_HopDongCGKT"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="CDT_HopDongCGKT"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.CDT_HopDongCGKT_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="CDT_HopDongCGKT"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="CDT_HopDongCGKT"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_HopDongCGKT_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="CDT_HopDongCGKT"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_HopDongCGKT_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="CDT_HopDongCGKT"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="CDT_HopDongCGKT"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_HopDongCGKT_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
