...
//
// Filename:    CDT_CanBoNhanCGKT
// ObjectType:  CDT_CanBoNhanCGKT
...
namespace ModuleChiDaoTuyen.LIB
{
    ...
    /// <summary>
    /// CDT_CanBoNhanCGKT (editable root object).<br/>
    /// This is a generated base class of <see cref="CDT_CanBoNhanCGKT"/> business object.
    /// </summary>
    [Serializable]
    public partial class CDT_CanBoNhanCGKT : BusinessBase<CDT_CanBoNhanCGKT>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="CDT_CanBoNhanCGKT"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="CDT_CanBoNhanCGKT"/> object.</returns>
        public static CDT_CanBoNhanCGKT NewCDT_CanBoNhanCGKT()
        {
            return DataPortal.Create<CDT_CanBoNhanCGKT>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="CDT_CanBoNhanCGKT"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the CDT_CanBoNhanCGKT to fetch.</param>
        /// <returns>A reference to the fetched <see cref="CDT_CanBoNhanCGKT"/> object.</returns>
        public static CDT_CanBoNhanCGKT GetCDT_CanBoNhanCGKT(int id)
        {
            return DataPortal.Fetch<CDT_CanBoNhanCGKT>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="CDT_CanBoNhanCGKT"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the CDT_CanBoNhanCGKT to delete.</param>
        public static void DeleteCDT_CanBoNhanCGKT(int id)
        {
            DataPortal.Delete<CDT_CanBoNhanCGKT>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="CDT_CanBoNhanCGKT"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewCDT_CanBoNhanCGKT(EventHandler<DataPortalResult<CDT_CanBoNhanCGKT>> callback)
        {
            DataPortal.BeginCreate<CDT_CanBoNhanCGKT>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="CDT_CanBoNhanCGKT"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the CDT_CanBoNhanCGKT to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetCDT_CanBoNhanCGKT(int id, EventHandler<DataPortalResult<CDT_CanBoNhanCGKT>> callback)
        {
            DataPortal.BeginFetch<CDT_CanBoNhanCGKT>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="CDT_CanBoNhanCGKT"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the CDT_CanBoNhanCGKT to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteCDT_CanBoNhanCGKT(int id, EventHandler<DataPortalResult<CDT_CanBoNhanCGKT>> callback)
        {
            DataPortal.BeginDelete<CDT_CanBoNhanCGKT>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CDT_CanBoNhanCGKT"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private CDT_CanBoNhanCGKT()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="CDT_CanBoNhanCGKT"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="CDT_CanBoNhanCGKT"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.CDT_CanBoNhanCGKT_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="CDT_CanBoNhanCGKT"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="CDT_CanBoNhanCGKT"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_CanBoNhanCGKT_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="CDT_CanBoNhanCGKT"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_CanBoNhanCGKT_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="CDT_CanBoNhanCGKT"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="CDT_CanBoNhanCGKT"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_CanBoNhanCGKT_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
