...
//
// Filename:    CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho
// ObjectType:  CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho
...
namespace ModuleChiDaoTuyen.LIB
{
    ...
    /// <summary>
    /// CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho (editable root object).<br/>
    /// This is a generated base class of <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> business object.
    /// </summary>
    [Serializable]
    public partial class CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho : BusinessBase<CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho>
    {
        ...
        public SmartDate ThoiGianBatDau
        {
        ...
        public SmartDate ThoiGianKetThuc
        {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object.</returns>
        public static CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho NewCDT_PhieuKhaoSat_DaoTaoLienTucTaiCho()
        {
            return DataPortal.Create<CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The Id parameter of the CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho to fetch.</param>
        /// <returns>A reference to the fetched <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object.</returns>
        public static CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho GetCDT_PhieuKhaoSat_DaoTaoLienTucTaiCho(int id)
        {
            return DataPortal.Fetch<CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The Id of the CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho to delete.</param>
        public static void DeleteCDT_PhieuKhaoSat_DaoTaoLienTucTaiCho(int id)
        {
            DataPortal.Delete<CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewCDT_PhieuKhaoSat_DaoTaoLienTucTaiCho(EventHandler<DataPortalResult<CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho>> callback)
        {
            DataPortal.BeginCreate<CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The Id parameter of the CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetCDT_PhieuKhaoSat_DaoTaoLienTucTaiCho(int id, EventHandler<DataPortalResult<CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho>> callback)
        {
            DataPortal.BeginFetch<CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The Id of the CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteCDT_PhieuKhaoSat_DaoTaoLienTucTaiCho(int id, EventHandler<DataPortalResult<CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho>> callback)
        {
            DataPortal.BeginDelete<CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.CDT_PhieuKhaoSat_DaoTaoLienTucTaiCho_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Id", id).DbType = DbType.Int32;
