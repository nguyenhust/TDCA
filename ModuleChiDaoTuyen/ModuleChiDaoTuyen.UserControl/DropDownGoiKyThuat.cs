...
{
    public partial class DropDownGoiKyThuat : RadMultiColumnComboBox
    {
        private CDT_GoiKT_Coll listItem;
        public DropDownGoiKyThuat()
        {
            InitializeComponent();
        ...
        {
            object obj = GlobalCommon.CacheReader(TextMessages.CacheID.CDT_GoiKT);
            if (obj != null)
            {
                FillData(((CDT_GoiKT_Coll)obj).Clone());
            }
            else
            {

                listItem = CDT_GoiKT_Coll.GetCDT_GoiKT_Coll(new BusinessFunction(BusinessFunctionMode.GetAllData));
                GlobalCommon.CacheWriter(TextMessages.CacheID.CDT_GoiKT, listItem);
                BindData();
            }
        ...
        public void FillData(CDT_GoiKT_Coll listItem)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public CDT_GoiKT_Coll GetListData()
        {
            return listItem;
        }
