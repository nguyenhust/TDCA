...
namespace TruyenThong.LIB
{
    ...
    public partial class TT_AnhVideo : BusinessBase<TT_AnhVideo>
    {
        ...
        {
            this.BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(SoLuongProperty,"Phải có số lượng chứ"));
        }
        ...
        public override TT_AnhVideo Save()
        {
        ...
        private void Fetch(SafeDataReader dr)
        {
            ...
            LoadProperty(IDSuKienProperty, dr.GetInt64("IDSuKien"));
            LoadProperty(IDCanBoProperty, dr.GetInt64("IDCanBo"));
            LoadProperty(LoaiProperty, dr.GetBoolean("Loai"));
