...
namespace TruyenThong.LIB
{
    ...
    /// <summary>
    /// TT_PhieuDangKyThietKe_Coll (editable root list).<br/>
    ...
    /// </remarks>
    [Serializable]
    public partial class TT_PhieuDangKyThietKe_Coll : BusinessBindingListBase<TT_PhieuDangKyThietKe_Coll, TT_PhieuDangKyThietKe_Info>
    {

        #region Collection Business Methods

        /// <summary>
        /// Removes a <see cref="TT_PhieuDangKyThietKe_Info"/> item from the collection.
        /// </summary>
        ...
        public void Remove(Int64 id)
        {
            foreach (var tT_PhieuDangKyThietKe_Info in this)
            {
                ...
                {
                    Remove(tT_PhieuDangKyThietKe_Info);
                    break;
                }
            }
        }
        ...
        /// <summary>
        /// Determines whether a <see cref="TT_PhieuDangKyThietKe_Info"/> item is in the collection's DeletedList.
        /// </summary>
        /// <param name="id">The ID of the item to search for.</param>
        /// <returns><c>true</c> if the TT_PhieuDangKyThietKe_Info is a deleted collection item; otherwise, <c>false</c>.</returns>
        public bool ContainsDeleted(Int64 id)
        {
            foreach (var tT_PhieuDangKyThietKe_Info in this.DeletedList)
            {
                if (tT_PhieuDangKyThietKe_Info.ID == id)
                {
                    return true;
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="TT_PhieuDangKyThietKe_Coll"/> collection.
        /// </summary>
        /// <returns>A reference to the created <see cref="TT_PhieuDangKyThietKe_Coll"/> collection.</returns>
        public static TT_PhieuDangKyThietKe_Coll NewTT_PhieuDangKyThietKe_Coll()
        {
            return DataPortal.Create<TT_PhieuDangKyThietKe_Coll>();
        }
        ...
        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="TT_PhieuDangKyThietKe_Coll"/> collection.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewTT_PhieuDangKyThietKe_Coll(EventHandler<DataPortalResult<TT_PhieuDangKyThietKe_Coll>> callback)
        {
            DataPortal.BeginCreate<TT_PhieuDangKyThietKe_Coll>(callback);
        }
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="TT_PhieuDangKyThietKe_Coll"/> object.
        /// </summary>
