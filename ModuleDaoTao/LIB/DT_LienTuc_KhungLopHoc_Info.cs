...
//
// Filename:    DT_LienTuc_KhungLopHoc_Info
// ObjectType:  DT_LienTuc_KhungLopHoc_Info
...
namespace ModuleDaoTao.LIB
{
    ...
    /// <summary>
    /// DT_LienTuc_KhungLopHoc_Info (editable child object).<br/>
    /// This is a generated base class of <see cref="DT_LienTuc_KhungLopHoc_Info"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is an item of <see cref="DT_LienTuc_KhungLopHoc_Coll"/> collection.
    /// </remarks>
    [Serializable]
    public partial class DT_LienTuc_KhungLopHoc_Info : BusinessBase<DT_LienTuc_KhungLopHoc_Info>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="DT_LienTuc_KhungLopHoc_Info"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="DT_LienTuc_KhungLopHoc_Info"/> object.</returns>
        internal static DT_LienTuc_KhungLopHoc_Info NewDT_LienTuc_KhungLopHoc_Info()
        {
            return DataPortal.CreateChild<DT_LienTuc_KhungLopHoc_Info>();
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="DT_LienTuc_KhungLopHoc_Info"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        internal static void NewDT_LienTuc_KhungLopHoc_Info(EventHandler<DataPortalResult<DT_LienTuc_KhungLopHoc_Info>> callback)
        {
            DataPortal.BeginCreate<DT_LienTuc_KhungLopHoc_Info>(callback);
        }

        /// <summary>
        /// Factory method. Loads a <see cref="DT_LienTuc_KhungLopHoc_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        /// <returns>A reference to the fetched <see cref="DT_LienTuc_KhungLopHoc_Info"/> object.</returns>
        internal static DT_LienTuc_KhungLopHoc_Info GetDT_LienTuc_KhungLopHoc_Info(SafeDataReader dr, BusinessFunction function)
        {
            DT_LienTuc_KhungLopHoc_Info obj = new DT_LienTuc_KhungLopHoc_Info();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DT_LienTuc_KhungLopHoc_Info"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private DT_LienTuc_KhungLopHoc_Info()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="DT_LienTuc_KhungLopHoc_Info"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="DT_LienTuc_KhungLopHoc_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        ...
        /// <summary>
        /// Inserts a new <see cref="DT_LienTuc_KhungLopHoc_Info"/> object in the database.
        /// </summary>
        private void Child_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DT_LienTuc_KhungLopHoc_Info_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="DT_LienTuc_KhungLopHoc_Info"/> object.
        /// </summary>
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DT_LienTuc_KhungLopHoc_Info_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="DT_LienTuc_KhungLopHoc_Info"/> object from database.
        /// </summary>
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DT_LienTuc_KhungLopHoc_Info_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@id", ReadProperty(IdProperty)).DbType = DbType.Int32;
