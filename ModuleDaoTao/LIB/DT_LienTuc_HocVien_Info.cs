...
//
// Filename:    DT_LienTuc_HocVien_Info
// ObjectType:  DT_LienTuc_HocVien_Info
...
namespace ModuleDaoTao.LIB
{
    ...
    /// <summary>
    /// DT_LienTuc_HocVien_Info (editable child object).<br/>
    /// This is a generated base class of <see cref="DT_LienTuc_HocVien_Info"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is an item of <see cref="DT_LienTuc_HocVien_Coll"/> collection.
    /// </remarks>
    [Serializable]
    public partial class DT_LienTuc_HocVien_Info : BusinessBase<DT_LienTuc_HocVien_Info>
    {
        ...
        /// Maintains metadata about <see cref="NgaySinh"/> property.
        /// </summary>
        public static readonly PropertyInfo<bool> XepLopProperty = RegisterProperty<bool>(p => p.XepLop, "Xep Lop");
        /// <summary>
        /// Gets or sets the Ngay Sinh.
        /// </summary>
        /// <value>The Ngay Sinh.</value>
        public bool XepLop
        {
            get { return GetProperty(XepLopProperty); }
            set { SetProperty(XepLopProperty, value); }
        }

        /// <summary>
        /// Maintains metadata about <see cref="NgaySinh"/> property.
        /// </summary>
        public static readonly PropertyInfo<bool> ChonProperty = RegisterProperty<bool>(p => p.Chon, "Chon");
        /// <summary>
        /// Gets or sets the Ngay Sinh.
        /// </summary>
        /// <value>The Ngay Sinh.</value>
        public bool Chon
        {
            get { return GetProperty(ChonProperty); }
            set { SetProperty(ChonProperty, value); }
        }
 ...
 /// <summary>
        ...
        /// </summary>
        public static readonly PropertyInfo<int?> Backup05Property = RegisterProperty<int?>(p => p.TongSoTiet, "backup05");
        /// <summary>
        ...
        public static readonly PropertyInfo<int?> SoTietProperty = RegisterProperty<int?>(p => p.SoTiet, "TongSoTiet");
        /// <summary>
        /// Gets or sets the backup05.
        /// </summary>
        /// <value>The backup05.</value>
        public int? SoTiet
        {
            get { return GetProperty(SoTietProperty); }
            set { SetProperty(SoTietProperty, value); }
        }
        /// <summary>
        ...
        public string TenBenhVien
        {
            get {
                ...
                string x = GetProperty(TenBenhVienProperty);
        ...
        public string TenLopHoc
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(GetProperty(TenLopHocProperty)) && HinhThucHoc == DT_Common.KemCap)
                    return NoiDungDaoTao;
                else
                    return GetProperty(TenLopHocProperty);
            }
        ...
        public DateTime DateNgayCapCMT
        {
            get { return GetProperty(NgayCapCMTProperty); }
        }
        ...
        public DateTime DateNgayHoanTien
        {
            get { return GetProperty(NgayDongProperty); }
        }
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="DT_LienTuc_HocVien_Info"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="DT_LienTuc_HocVien_Info"/> object.</returns>
        internal static DT_LienTuc_HocVien_Info NewDT_LienTuc_HocVien_Info()
        {
            return DataPortal.CreateChild<DT_LienTuc_HocVien_Info>();
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="DT_LienTuc_HocVien_Info"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        internal static void NewDT_LienTuc_HocVien_Info(EventHandler<DataPortalResult<DT_LienTuc_HocVien_Info>> callback)
        {
            DataPortal.BeginCreate<DT_LienTuc_HocVien_Info>(callback);
        }

        /// <summary>
        /// Factory method. Loads a <see cref="DT_LienTuc_HocVien_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        /// <returns>A reference to the fetched <see cref="DT_LienTuc_HocVien_Info"/> object.</returns>
        internal static DT_LienTuc_HocVien_Info GetDT_LienTuc_HocVien_Info(SafeDataReader dr, BusinessFunction function)
        {
            DT_LienTuc_HocVien_Info obj = new DT_LienTuc_HocVien_Info();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DT_LienTuc_HocVien_Info"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private DT_LienTuc_HocVien_Info()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="DT_LienTuc_HocVien_Info"/> object properties.
        /// </summary>
        [Csla.RunLocal]
...
LoadProperty(GhiChuProperty, null);
 ...
 LoadProperty(NgayDongDetailProperty, null);
            ...
            LoadProperty(SoTietProperty, null);
        ...
        /// <summary>
        /// Loads a <see cref="DT_LienTuc_HocVien_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        private void Fetch(SafeDataReader dr, BusinessFunction function)
         {
            ...
            time = dr.GetValue("NgayCapCMT");
            if (time == null)
                LoadProperty(NgayCapCMTProperty, null);
            else
                LoadProperty(NgayCapCMTProperty, dr.GetDateTime("NgayCapCMT"));
            ...
            if (time == null)
                ...
                LoadProperty(NgayDangKiProperty, dr.GetDateTime("NgayDangKi"));
            ...
            LoadProperty(ShowNgayBatDauProperty, dr.GetDateTime("NgayBatDau"));
            ...
            bool isXepLop = string.IsNullOrEmpty(dr.GetString("MaLopHoc")) ? false : true;
            LoadProperty(XepLopProperty, isXepLop);
            ...
            LoadProperty(SoTietProperty, dr.GetInt32("TongSoTiet"));
            ...
            if (TongHocPhi.ToLower().Trim() == TongTienHoc.ToLower().Trim() && string.IsNullOrEmpty(SoTienHoan))
                DaHoanThanhHocPhi = true;
            else
                DaHoanThanhHocPhi = false;
            var args = new DataPortalHookArgs(dr);
            OnFetchRead(args);
        }

        /// <summary>
        /// Inserts a new <see cref="DT_LienTuc_HocVien_Info"/> object in the database.
        /// </summary>
        private void Child_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DT_LienTuc_HocVien_Info_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="DT_LienTuc_HocVien_Info"/> object.
        /// </summary>
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DT_LienTuc_HocVien_Info_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="DT_LienTuc_HocVien_Info"/> object from database.
        /// </summary>
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DT_LienTuc_HocVien_Info_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@id", ReadProperty(IdProperty)).DbType = DbType.Int32;
