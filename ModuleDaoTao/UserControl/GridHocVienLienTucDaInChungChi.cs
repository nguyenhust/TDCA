...
{
    public partial class GridHocVienLienTucDaInChungChi : UsDictionary
    {
        #region variables
        ...
        public GridHocVienLienTucDaInChungChi()
        {
            InitializeComponent();
        ...
        {
            return TextMessages.ControlID.DT_HocVienLienTuc_DaInChungChi;
        }
        ...
        {
            return TextMessages.FormTitle.DT_HocVienLienTuc_DaInChungChi;
        }
        ...
        protected override void LoadUS()
        {
            try
            {
                BusinessFunction function = new BusinessFunction(BusinessFunctionMode.GetDTLienTuc_HVDaInChungChi);
