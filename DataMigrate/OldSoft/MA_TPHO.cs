...
namespace oldSoft
{
    ...
    /// <summary>
    /// MA_TPHO (editable root object).<br/>
    /// This is a generated base class of <see cref="MA_TPHO"/> business object.
    /// </summary>
    [Serializable]
    public partial class MA_TPHO : BusinessBase<MA_TPHO>
    {
        ...
        /// </summary>
        public static readonly PropertyInfo<string> MA_TPHOProperty = RegisterProperty<string>(p => p.MA_TPHOx, "MA TPHO");
        /// <summary>
        /// CDT.MA_TPHO.MA_TPHO
        /// </summary>
        /// <value>The MA TPHO.</value>
        public string MA_TPHOx
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MA_TPHO"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Loads a <see cref="MA_TPHO"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="MA_TPHO"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection2"))
            {
                using (var cmd = new SqlCommand("dbo.MA_TPHO_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="MA_TPHO"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection2"))
            {
                using (var cmd = new SqlCommand("dbo.MA_TPHO_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@MA_TPHO", ReadProperty(MA_TPHOProperty)).DbType = DbType.String;
