...
{
    public partial class DropDownCanBo : RadMultiColumnComboBox
    {
        DIC_CanBo_Coll listItem;
        public List<string> DanhMucCotHienThi { get; set; }
        public List<string> TenTuongUng { get; set; }
        public DropDownCanBo()
        {
            InitializeComponent();
            this.Text = string.Empty;
            this.NullText = "Chọn Cán bộ";
            DanhMucCotHienThi = new List<string>() { "HoTen" };
            TenTuongUng = new List<string>() { "Họ tên cán bộ" };
        }
        ...
        {
            FillData(LoaiCanBo.CanBoThuocTrungTamCDT,STT);
        }
        /// <summary>
        /// Lấy tất cả data với Loại cán bộ tương ứng
        /// </summary>
        /// <param name="loaiCanBo"></param>
        public void FillData(LoaiCanBo loaiCanBo, int STT)
        {
            ...
            else
            {
                ...
                GlobalCommon.CacheWriter(TextMessages.CacheID.DIC_CanBo + STT.ToString(), listItem);
                BindData();
            }
        ...
        /// </summary>
        /// <returns></returns>
        public DIC_CanBo_Coll GetListData()
        {
            return listItem;
        }
