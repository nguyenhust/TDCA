...
{
    public partial class DropDownNoiDungHoc : RadMultiColumnComboBox
    {
        DIC_BoPhan_Coll listItem;
        public DropDownNoiDungHoc()
        {
            InitializeComponent();
            this.Text = string.Empty;
            this.NullText = "Chọn Nội dung học";
        }
        ...
        /// </summary>
        /// <param name="filter">gia tri j cung duoc</param>
        /// <param name="item">Id cua Chuyên Ngành</param>
