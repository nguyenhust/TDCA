...
{
    public partial class DropDownChucVu : RadMultiColumnComboBox
    {
        DIC_ChucVu_Coll listItem;
        public DropDownChucVu()
        {
            InitializeComponent();
            this.Text = string.Empty;
            this.NullText = "Chọn Chức vụ";
        }
        ...
        private void BindData()
        {
            ...
            gridViewControl.Columns[columnVisible].HeaderText = "Chức vụ";
            gridViewControl.MasterTemplate.AutoGenerateColumns = false;
            gridViewControl.MasterTemplate.AutoSizeColumnsMode = GridViewAutoSizeColumnsMode.Fill;
        ...
        {
            object obj = GlobalCommon.CacheReader(TextMessages.CacheID.DIC_ChucVu + STT.ToString());
            if (obj != null)
            {
                FillData((DIC_ChucVu_Coll)obj);
            }
            else
            {

                listItem = DIC_ChucVu_Coll.GetDIC_ChucVu_Coll();
                GlobalCommon.CacheWriter(TextMessages.CacheID.DIC_ChucVu + STT.ToString(), listItem);
            }
            BindData();
        }
        ...
        public void FillData(DIC_ChucVu_Coll chucVu)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public DIC_ChucVu_Coll GetListData()
        {
            return listItem;
        }
        /// <summary>
