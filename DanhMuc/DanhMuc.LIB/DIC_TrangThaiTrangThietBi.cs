...
{
    [Serializable]
    public partial class DIC_TrangThaiTrangThietBi : BusinessBase<DIC_TrangThaiTrangThietBi>
    {
        ...
        public static DIC_TrangThaiTrangThietBi NewDIC_TrangThaiTrangThietBi()
        {
            return DataPortal.Create<DIC_TrangThaiTrangThietBi>();
        }
        ...
        public static DIC_TrangThaiTrangThietBi GetDIC_TrangThaiTrangThietBi(Int64 id)
        {
            return DataPortal.Fetch<DIC_TrangThaiTrangThietBi>(id);
        }
        ...
        public static void DeleteDIC_TrangThaiTrangThietBi(int id)
        {
            DataPortal.Delete<DIC_TrangThaiTrangThietBi>(id);
        }
        ...
        public static void NewDIC_TrangThaiTrangThietBi(EventHandler<DataPortalResult<DIC_TrangThaiTrangThietBi>> callback)
        {
            DataPortal.BeginCreate<DIC_TrangThaiTrangThietBi>(callback);
        }
        ...
        /// <param name="id">The ID parameter of the DIC_ChucVu to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetDIC_TrangThaiTrangThietBi(int id, EventHandler<DataPortalResult<DIC_TrangThaiTrangThietBi>> callback)
        {
            DataPortal.BeginFetch<DIC_TrangThaiTrangThietBi>(id, callback);
        }
        ...
        /// <param name="id">The ID of the DIC_ChucVu to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteDIC_TrangThaiTrangThietBi(int id, EventHandler<DataPortalResult<DIC_TrangThaiTrangThietBi>> callback)
        {
            DataPortal.BeginDelete<DIC_TrangThaiTrangThietBi>(id, callback);
        }
        ...
        private DIC_TrangThaiTrangThietBi()
        {
        ...
        protected void DataPortal_Fetch(Int64 id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_TrangThaiTrangThietBi_get", ctx.Connection))
                {
        ...
        protected override void DataPortal_Insert()
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_TrangThaiTrangThietBi_add", ctx.Connection))
                {
        ...
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_TrangThaiTrangThietBi_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void DataPortal_Delete(Int64 id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_TrangThaiTrangThietBi_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@IDTrangThai", id).DbType = DbType.Int64;
