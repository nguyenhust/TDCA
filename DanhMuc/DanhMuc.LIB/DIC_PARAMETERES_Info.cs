...
namespace DanhMuc.LIB
{
    ...
    public partial class DIC_PARAMETERES_Info : BusinessBase<DIC_PARAMETERES_Info>
    {
        ...
        protected override void AddBusinessRules()
        {
            ...
            BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(ParaNameProperty,"Nhập ParameterName"));
            BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(ParaRollProperty, "Nhập ParameterRoll"));
            BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(ParaTypeProperty, "Nhập ParameterType"));
            BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(ParaValueProperty, "Nhập ParameterValue"));
        }
        #endregion
