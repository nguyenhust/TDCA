...
namespace DanhMuc.LIB
{
    ...
    /// <summary>
    /// DIC_ChucVu (editable root object).<br/>
    /// This is a generated base class of <see cref="DIC_ChucVu"/> business object.
    /// </summary>
    [Serializable]
    public partial class DIC_ChucVu : BusinessBase<DIC_ChucVu>
    {
        ...
        public static DIC_ChucVu NewDIC_ChucVu()
        {
            return DataPortal.Create<DIC_ChucVu>();
        }
        ...
        public static DIC_ChucVu GetDIC_ChucVu(int id)
        {
            return DataPortal.Fetch<DIC_ChucVu>(id);
        }
        ...
        public static void DeleteDIC_ChucVu(int id)
        {
            DataPortal.Delete<DIC_ChucVu>(id);
        }
        ...
        public static void NewDIC_ChucVu(EventHandler<DataPortalResult<DIC_ChucVu>> callback)
        {
            DataPortal.BeginCreate<DIC_ChucVu>(callback);
        }
        ...
        /// <param name="id">The ID parameter of the DIC_ChucVu to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetDIC_ChucVu(int id, EventHandler<DataPortalResult<DIC_ChucVu>> callback)
        {
            DataPortal.BeginFetch<DIC_ChucVu>(id, callback);
        }
        ...
        /// <param name="id">The ID of the DIC_ChucVu to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteDIC_ChucVu(int id, EventHandler<DataPortalResult<DIC_ChucVu>> callback)
        {
            DataPortal.BeginDelete<DIC_ChucVu>(id, callback);
        }
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_ChucVu_get", ctx.Connection))
                {
        ...
        protected override void DataPortal_Insert()
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_ChucVu_add", ctx.Connection))
                {
        ...
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_ChucVu_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_ChucVu_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
