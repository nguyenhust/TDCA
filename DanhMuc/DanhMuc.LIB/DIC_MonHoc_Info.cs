...
//
// Filename:    DIC_MonHoc_Info
// ObjectType:  DIC_MonHoc_Info
...
namespace DanhMuc.LIB
{
    ...
    /// <summary>
    /// DIC_MonHoc_Info (editable child object).<br/>
    /// This is a generated base class of <see cref="DIC_MonHoc_Info"/> business object.
    /// </summary>
    /// <remarks>
    /// This class is an item of <see cref="DIC_MonHoc_Coll"/> collection.
    /// </remarks>
    [Serializable]
    public partial class DIC_MonHoc_Info : BusinessBase<DIC_MonHoc_Info>
    {
        ...
        protected override void AddBusinessRules()
        {
             ...
             BusinessRules.AddRule(new Csla.Rules.CommonRules.Required(TenProperty,"Chưa nhập tên môn học"));
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="DIC_MonHoc_Info"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="DIC_MonHoc_Info"/> object.</returns>
        internal static DIC_MonHoc_Info NewDIC_MonHoc_Info()
        {
            return DataPortal.CreateChild<DIC_MonHoc_Info>();
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="DIC_MonHoc_Info"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        internal static void NewDIC_MonHoc_Info(EventHandler<DataPortalResult<DIC_MonHoc_Info>> callback)
        {
            DataPortal.BeginCreate<DIC_MonHoc_Info>(callback);
        }

        /// <summary>
        /// Factory method. Loads a <see cref="DIC_MonHoc_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        /// <returns>A reference to the fetched <see cref="DIC_MonHoc_Info"/> object.</returns>
        internal static DIC_MonHoc_Info GetDIC_MonHoc_Info(SafeDataReader dr)
        {
            DIC_MonHoc_Info obj = new DIC_MonHoc_Info();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DIC_MonHoc_Info"/> class.
        /// </summary>
        /// <remarks> Do not use to create a Csla object. Use factory methods instead.</remarks>
        private DIC_MonHoc_Info()
        {
        ...
        /// <summary>
        /// Loads default values for the <see cref="DIC_MonHoc_Info"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="DIC_MonHoc_Info"/> object from the given SafeDataReader.
        /// </summary>
        /// <param name="dr">The SafeDataReader to use.</param>
        ...
        /// <summary>
        /// Inserts a new <see cref="DIC_MonHoc_Info"/> object in the database.
        /// </summary>
        private void Child_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_MonHoc_Info_Add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="DIC_MonHoc_Info"/> object.
        /// </summary>
        private void Child_Update()
        {
            ...
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_MonHoc_Info_Upd", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="DIC_MonHoc_Info"/> object from database.
        /// </summary>
        private void Child_DeleteSelf()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_MonHoc_Info_Delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", ReadProperty(IDProperty)).DbType = DbType.Int64;
