...
namespace DanhMuc.LIB
{
    ...
    /// <summary>
    /// DIC_MonHoc (editable root object).<br/>
    /// This is a generated base class of <see cref="DIC_MonHoc"/> business object.
    /// </summary>
    [Serializable]
    public partial class DIC_MonHoc : BusinessBase<DIC_MonHoc>
    {
        ...
        /// <summary>
        /// Factory method. Creates a new <see cref="DIC_MonHoc"/> object.
        /// </summary>
        /// <returns>A reference to the created <see cref="DIC_MonHoc"/> object.</returns>
        public static DIC_MonHoc NewDIC_MonHoc()
        {
            return DataPortal.Create<DIC_MonHoc>();
        }

        /// <summary>
        /// Factory method. Loads a <see cref="DIC_MonHoc"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the DIC_MonHoc to fetch.</param>
        /// <returns>A reference to the fetched <see cref="DIC_MonHoc"/> object.</returns>
        public static DIC_MonHoc GetDIC_MonHoc(Int64 id)
        {
            return DataPortal.Fetch<DIC_MonHoc>(id);
        }

        /// <summary>
        /// Factory method. Deletes a <see cref="DIC_MonHoc"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the DIC_MonHoc to delete.</param>
        public static void DeleteDIC_MonHoc(Int64 id)
        {
            DataPortal.Delete<DIC_MonHoc>(id);
        }

        /// <summary>
        /// Factory method. Asynchronously creates a new <see cref="DIC_MonHoc"/> object.
        /// </summary>
        /// <param name="callback">The completion callback method.</param>
        public static void NewDIC_MonHoc(EventHandler<DataPortalResult<DIC_MonHoc>> callback)
        {
            DataPortal.BeginCreate<DIC_MonHoc>(callback);
        }

        /// <summary>
        /// Factory method. Asynchronously loads a <see cref="DIC_MonHoc"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID parameter of the DIC_MonHoc to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetDIC_MonHoc(Int64 id, EventHandler<DataPortalResult<DIC_MonHoc>> callback)
        {
            DataPortal.BeginFetch<DIC_MonHoc>(id, callback);
        }

        /// <summary>
        /// Factory method. Asynchronously deletes a <see cref="DIC_MonHoc"/> object, based on given parameters.
        /// </summary>
        /// <param name="id">The ID of the DIC_MonHoc to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteDIC_MonHoc(Int64 id, EventHandler<DataPortalResult<DIC_MonHoc>> callback)
        {
            DataPortal.BeginDelete<DIC_MonHoc>(id, callback);
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DIC_MonHoc"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Loads default values for the <see cref="DIC_MonHoc"/> object properties.
        /// </summary>
        [Csla.RunLocal]
        ...
        /// <summary>
        /// Loads a <see cref="DIC_MonHoc"/> object from the database, based on given criteria.
        /// </summary>
        ...
        protected void DataPortal_Fetch(Int64 id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_MonHoc_get", ctx.Connection))
                {
        ...
        /// <summary>
        /// Loads a <see cref="DIC_MonHoc"/> object from the given SafeDataReader.
        /// </summary>
        ...
        /// <summary>
        /// Inserts a new <see cref="DIC_MonHoc"/> object in the database.
        /// </summary>
        protected override void DataPortal_Insert()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_MonHoc_add", ctx.Connection))
                {
        ...
        /// <summary>
        /// Updates in the database all changes made to the <see cref="DIC_MonHoc"/> object.
        /// </summary>
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_MonHoc_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Self deletes the <see cref="DIC_MonHoc"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the <see cref="DIC_MonHoc"/> object from database.
        /// </summary>
        ...
        protected void DataPortal_Delete(Int64 id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_MonHoc_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int64;
