...
namespace DanhMuc.LIB
{
    ...
    /// <summary>
    /// DIC_Loai (editable root object).<br/>
    /// This is a generated base class of <see cref="DIC_Loai"/> business object.
    /// </summary>
    [Serializable]
    public partial class DIC_Loai : BusinessBase<DIC_Loai>
    {
        ...
        public static DIC_Loai NewDIC_Loai()
        {
            return DataPortal.Create<DIC_Loai>();
        }
        ...
        public static DIC_Loai GetDIC_Loai(int id)
        {
            return DataPortal.Fetch<DIC_Loai>(id);
        }
        ...
        public static void DeleteDIC_Loai(int id)
        {
            DataPortal.Delete<DIC_Loai>(id);
        }
        ...
        public static void NewDIC_Loai(EventHandler<DataPortalResult<DIC_Loai>> callback)
        {
            DataPortal.BeginCreate<DIC_Loai>(callback);
        }
        ...
        /// <param name="id">The ID parameter of the DIC_Loai to fetch.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void GetDIC_Loai(int id, EventHandler<DataPortalResult<DIC_Loai>> callback)
        {
            DataPortal.BeginFetch<DIC_Loai>(id, callback);
        }
        ...
        /// <param name="id">The ID of the DIC_Loai to delete.</param>
        /// <param name="callback">The completion callback method.</param>
        public static void DeleteDIC_Loai(int id, EventHandler<DataPortalResult<DIC_Loai>> callback)
        {
            DataPortal.BeginDelete<DIC_Loai>(id, callback);
        }
        ...
        protected void DataPortal_Fetch(int id)
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_Loai_get", ctx.Connection))
                {
        ...
        protected override void DataPortal_Insert()
        {
            ...
            {
                using (var cmd = new SqlCommand("dbo.DIC_Loai_add", ctx.Connection))
                {
        ...
        protected override void DataPortal_Update()
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_Loai_update", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void DataPortal_Delete(int id)
        {
            using (var ctx = TransactionManager<SqlConnection, SqlTransaction>.GetManager("Connection"))
            {
                using (var cmd = new SqlCommand("dbo.DIC_Loai_delete", ctx.Connection))
                {
                    cmd.Transaction = ctx.Transaction;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id).DbType = DbType.Int32;
